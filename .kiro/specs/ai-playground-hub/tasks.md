...
- [x] 5-1. 하단 광고 배너 컴포넌트 구현




  - AdBannerComponent 클래스 및 템플릿 생성
  - 구글 애드센스 광고 스크립트 삽입 로직 구현
  - 반응형 광고 슬롯 마크업 작성
  - 광고 로딩 실패 시 자동 축소 처리 구현
  - _Requirements: 9.1, 9.2, 9.3_

- [x] 6. CategoryFilterComponent 구현
...
- [x] 9. Turbo Frames를 활용한 카테고리 필터링 구현
...
- [x] 10. 메인 페이지 레이아웃 조립 및 통합


  - application.html.erb 기본 레이아웃 설정
  - home.html.erb에서 모든 컴포넌트 조립 (FooterComponent 위에 AdBannerComponent 추가)
  - 컴포넌트 간 데이터 전달 및 상태 관리
  - 전체 페이지 플로우 테스트 및 디버깅
  - _Requirements: 전체 UI 통합_

- [x] 11. 썸네일 이미지 및 에셋 관리
...
- [x] 12. SEO 메타 태그 및 Open Graph 구현
