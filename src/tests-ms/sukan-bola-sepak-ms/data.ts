...
export const questions = [
  {
    id: 1,
    question: "Soalan pertama tentang Bola Sepak?",
    options: [
  ...
  {
    id: 2,
    question: "Bagaimana approach anda tentang Bola Sepak?",
    options: [
  ...
  {
    id: 3,
    question: "Bila berkaitan Bola Sepak, anda rasa?",
    options: [
  ...
  {
    id: 4,
    question: "Pengalaman anda dengan Bola Sepak?",
    options: [
  ...
  {
    id: 5,
    question: "Dalam konteks Bola Sepak, anda lebih...",
    options: [
  ...
  {
    id: 6,
    question: "Priority Bola Sepak dalam hidup anda?",
    options: [
  ...
  {
    id: 7,
    question: "Bila ada isu berkaitan Bola Sepak...",
    options: [
  ...
  {
    id: 8,
    question: "Orang sekeliling describe anda dalam Bola Sepak sebagai?",
    options: [
  ...
  {
    id: 9,
    question: "Future goals berkaitan Bola Sepak?",
    options: [
  ...
  {
    id: 10,
    question: "Overall, Bola Sepak untuk anda adalah?",
    options: [
...
export const results = {
  A: {
    type: "A",
    title: "Bola Sepak Champion",
    emoji: "⚽",
    description: "Anda sangat cemerlang dalam Bola Sepak! Passionate, dedicated, dan inspiring. Teruskan!",
  ...
  B: {
    type: "B",
    title: "Bola Sepak Pro",
    emoji: "⭐",
    description: "Anda balanced dan reliable dalam Bola Sepak! Good approach dengan sustainable habits.",
  ...
  C: {
    type: "C",
    title: "Bola Sepak Casual",
    emoji: "😊",
    description: "Anda casual dengan Bola Sepak. No stress approach, enjoy when it happens!",
  ...
  D: {
    type: "D",
    title: "Bola Sepak Newbie",
    emoji: "🌱",
    description: "Ruang untuk grow dalam Bola Sepak! Everyone starts somewhere. Take your time!",
