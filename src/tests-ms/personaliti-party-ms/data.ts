...
export const questions = [
  {
    id: 1,
    question: "Soalan pertama tentang Party?",
    options: [
  ...
  {
    id: 2,
    question: "Bagaimana approach anda tentang Party?",
    options: [
  ...
  {
    id: 3,
    question: "Bila berkaitan Party, anda rasa?",
    options: [
  ...
  {
    id: 4,
    question: "Pengalaman anda dengan Party?",
    options: [
  ...
  {
    id: 5,
    question: "Dalam konteks Party, anda lebih...",
    options: [
  ...
  {
    id: 6,
    question: "Priority Party dalam hidup anda?",
    options: [
  ...
  {
    id: 7,
    question: "Bila ada isu berkaitan Party...",
    options: [
  ...
  {
    id: 8,
    question: "Orang sekeliling describe anda dalam Party sebagai?",
    options: [
  ...
  {
    id: 9,
    question: "Future goals berkaitan Party?",
    options: [
  ...
  {
    id: 10,
    question: "Overall, Party untuk anda adalah?",
    options: [
...
export const results = {
  A: {
    ...
    emoji: "🎉",
    description: "Anda sangat cemerlang dalam Party! Passionate, dedicated, dan inspiring. Teruskan!",
  ...
  B: {
    ...
    title: "Party Pro",
    emoji: "⭐",
    description: "Anda balanced dan reliable dalam Party! Good approach dengan sustainable habits.",
  ...
  C: {
    ...
    title: "Party Casual",
    emoji: "😊",
    description: "Anda casual dengan Party. No stress approach, enjoy when it happens!",
  ...
  D: {
    ...
    title: "Party Newbie",
    emoji: "🌱",
    description: "Ruang untuk grow dalam Party! Everyone starts somewhere. Take your time!",
