...
export const questions = [
  {
    id: 1,
    question: "Soalan pertama tentang Dinner?",
    options: [
  ...
  {
    id: 2,
    question: "Bagaimana approach anda tentang Dinner?",
    options: [
  ...
  {
    id: 3,
    question: "Bila berkaitan Dinner, anda rasa?",
    options: [
  ...
  {
    id: 4,
    question: "Pengalaman anda dengan Dinner?",
    options: [
  ...
  {
    id: 5,
    question: "Dalam konteks Dinner, anda lebih...",
    options: [
  ...
  {
    id: 6,
    question: "Priority Dinner dalam hidup anda?",
    options: [
  ...
  {
    id: 7,
    question: "Bila ada isu berkaitan Dinner...",
    options: [
  ...
  {
    id: 8,
    question: "Orang sekeliling describe anda dalam Dinner sebagai?",
    options: [
  ...
  {
    id: 9,
    question: "Future goals berkaitan Dinner?",
    options: [
  ...
  {
    id: 10,
    question: "Overall, Dinner untuk anda adalah?",
    options: [
...
export const results = {
  A: {
    type: "A",
    title: "Dinner Champion",
    emoji: "🍽️",
    description: "Anda sangat cemerlang dalam Dinner! Passionate, dedicated, dan inspiring. Teruskan!",
  ...
  B: {
    ...
    title: "Dinner Pro",
    emoji: "⭐",
    description: "Anda balanced dan reliable dalam Dinner! Good approach dengan sustainable habits.",
  ...
  C: {
    ...
    title: "Dinner Casual",
    emoji: "😊",
    description: "Anda casual dengan Dinner. No stress approach, enjoy when it happens!",
  ...
  D: {
    ...
    title: "Dinner Newbie",
    emoji: "🌱",
    description: "Ruang untuk grow dalam Dinner! Everyone starts somewhere. Take your time!",
