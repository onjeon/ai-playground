// Rendang
// Jenis rendang lover anda?

export const questions = [
  {
    id: 1,
    question: "Soalan pertama tentang Rendang?",
    options: [
  ...
  {
    id: 2,
    question: "Bagaimana approach anda tentang Rendang?",
    options: [
  ...
  {
    id: 3,
    question: "Bila berkaitan Rendang, anda rasa?",
    options: [
  ...
  {
    id: 4,
    question: "Pengalaman anda dengan Rendang?",
    options: [
  ...
  {
    id: 5,
    question: "Dalam konteks Rendang, anda lebih...",
    options: [
  ...
  {
    id: 6,
    question: "Priority Rendang dalam hidup anda?",
    options: [
  ...
  {
    id: 7,
    question: "Bila ada isu berkaitan Rendang...",
    options: [
  ...
  {
    id: 8,
    question: "Orang sekeliling describe anda dalam Rendang sebagai?",
    options: [
  ...
  {
    id: 9,
    question: "Future goals berkaitan Rendang?",
    options: [
  ...
  {
    id: 10,
    question: "Overall, Rendang untuk anda adalah?",
    options: [
...
export const results = {
  A: {
    type: "A",
    title: "Rendang Champion",
    emoji: "🍛",
    description: "Anda sangat cemerlang dalam Rendang! Passionate, dedicated, dan inspiring. Teruskan!",
  ...
  B: {
    ...
    title: "Rendang Pro",
    emoji: "⭐",
    description: "Anda balanced dan reliable dalam Rendang! Good approach dengan sustainable habits.",
  ...
  C: {
    type: "C",
    title: "Rendang Casual",
    emoji: "😊",
    description: "Anda casual dengan Rendang. No stress approach, enjoy when it happens!",
  ...
  D: {
    type: "D",
    title: "Rendang Newbie",
    emoji: "🌱",
    description: "Ruang untuk grow dalam Rendang! Everyone starts somewhere. Take your time!",
