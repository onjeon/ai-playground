...
export const questions = [
  {
    id: 1,
    question: "Soalan pertama tentang Breakfast?",
    options: [
  ...
  {
    id: 2,
    question: "Bagaimana approach anda tentang Breakfast?",
    options: [
  ...
  {
    id: 3,
    question: "Bila berkaitan Breakfast, anda rasa?",
    options: [
  ...
  {
    id: 4,
    question: "Pengalaman anda dengan Breakfast?",
    options: [
  ...
  {
    id: 5,
    question: "Dalam konteks Breakfast, anda lebih...",
    options: [
  ...
  {
    id: 6,
    question: "Priority Breakfast dalam hidup anda?",
    options: [
  ...
  {
    id: 7,
    question: "Bila ada isu berkaitan Breakfast...",
    options: [
  ...
  {
    id: 8,
    question: "Orang sekeliling describe anda dalam Breakfast sebagai?",
    options: [
  ...
  {
    id: 9,
    question: "Future goals berkaitan Breakfast?",
    options: [
  ...
  {
    id: 10,
    question: "Overall, Breakfast untuk anda adalah?",
    options: [
...
export const results = {
  A: {
    ...
    emoji: "🍳",
    description: "Anda sangat cemerlang dalam Breakfast! Passionate, dedicated, dan inspiring. Teruskan!",
  ...
  B: {
    ...
    title: "Breakfast Pro",
    emoji: "⭐",
    description: "Anda balanced dan reliable dalam Breakfast! Good approach dengan sustainable habits.",
  ...
  C: {
    type: "C",
    title: "Breakfast Casual",
    emoji: "😊",
    description: "Anda casual dengan Breakfast. No stress approach, enjoy when it happens!",
  ...
  D: {
    type: "D",
    title: "Breakfast Newbie",
    emoji: "🌱",
    description: "Ruang untuk grow dalam Breakfast! Everyone starts somewhere. Take your time!",
