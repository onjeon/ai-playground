// Cendol
// Jenis cendol lover anda?

export const questions = [
  {
    id: 1,
    question: "Soalan pertama tentang Cendol?",
    options: [
  ...
  {
    id: 2,
    question: "Bagaimana approach anda tentang Cendol?",
    options: [
  ...
  {
    id: 3,
    question: "Bila berkaitan Cendol, anda rasa?",
    options: [
  ...
  {
    id: 4,
    question: "Pengalaman anda dengan Cendol?",
    options: [
  ...
  {
    id: 5,
    question: "Dalam konteks Cendol, anda lebih...",
    options: [
  ...
  {
    id: 6,
    question: "Priority Cendol dalam hidup anda?",
    options: [
  ...
  {
    id: 7,
    question: "Bila ada isu berkaitan Cendol...",
    options: [
  ...
  {
    id: 8,
    question: "Orang sekeliling describe anda dalam Cendol sebagai?",
    options: [
  ...
  {
    id: 9,
    question: "Future goals berkaitan Cendol?",
    options: [
  ...
  {
    id: 10,
    question: "Overall, Cendol untuk anda adalah?",
    options: [
...
export const results = {
  A: {
    type: "A",
    title: "Cendol Champion",
    emoji: "🍧",
    description: "Anda sangat cemerlang dalam Cendol! Passionate, dedicated, dan inspiring. Teruskan!",
  ...
  B: {
    ...
    title: "Cendol Pro",
    emoji: "⭐",
    description: "Anda balanced dan reliable dalam Cendol! Good approach dengan sustainable habits.",
  ...
  C: {
    ...
    title: "Cendol Casual",
    emoji: "😊",
    description: "Anda casual dengan Cendol. No stress approach, enjoy when it happens!",
  ...
  D: {
    ...
    title: "Cendol Newbie",
    emoji: "🌱",
    description: "Ruang untuk grow dalam Cendol! Everyone starts somewhere. Take your time!",
