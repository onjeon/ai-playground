// Online Banking
// Gaya online banking anda?

export const questions = [
  {
    id: 1,
    question: "Soalan pertama tentang Online Banking?",
    options: [
  ...
  {
    id: 2,
    question: "Bagaimana approach anda tentang Online Banking?",
    options: [
  ...
  {
    id: 3,
    question: "Bila berkaitan Online Banking, anda rasa?",
    options: [
  ...
  {
    id: 4,
    question: "Pengalaman anda dengan Online Banking?",
    options: [
  ...
  {
    id: 5,
    question: "Dalam konteks Online Banking, anda lebih...",
    options: [
  ...
  {
    id: 6,
    question: "Priority Online Banking dalam hidup anda?",
    options: [
  ...
  {
    id: 7,
    question: "Bila ada isu berkaitan Online Banking...",
    options: [
  ...
  {
    id: 8,
    question: "Orang sekeliling describe anda dalam Online Banking sebagai?",
    options: [
  ...
  {
    id: 9,
    question: "Future goals berkaitan Online Banking?",
    options: [
  ...
  {
    id: 10,
    question: "Overall, Online Banking untuk anda adalah?",
    options: [
...
export const results = {
  A: {
    type: "A",
    title: "Online Banking Champion",
    emoji: "🏦",
    description: "Anda sangat cemerlang dalam Online Banking! Passionate, dedicated, dan inspiring. Teruskan!",
  ...
  B: {
    type: "B",
    title: "Online Banking Pro",
    emoji: "⭐",
    description: "Anda balanced dan reliable dalam Online Banking! Good approach dengan sustainable habits.",
  ...
  C: {
    type: "C",
    title: "Online Banking Casual",
    emoji: "😊",
    description: "Anda casual dengan Online Banking. No stress approach, enjoy when it happens!",
  ...
  D: {
    type: "D",
    title: "Online Banking Newbie",
    emoji: "🌱",
    description: "Ruang untuk grow dalam Online Banking! Everyone starts somewhere. Take your time!",
