// Rojak
// Jenis rojak lover anda?

export const questions = [
  {
    id: 1,
    question: "Soalan pertama tentang Rojak?",
    options: [
  ...
  {
    id: 2,
    question: "Bagaimana approach anda tentang Rojak?",
    options: [
  ...
  {
    id: 3,
    question: "Bila berkaitan Rojak, anda rasa?",
    options: [
  ...
  {
    id: 4,
    question: "Pengalaman anda dengan Rojak?",
    options: [
  ...
  {
    id: 5,
    question: "Dalam konteks Rojak, anda lebih...",
    options: [
  ...
  {
    id: 6,
    question: "Priority Rojak dalam hidup anda?",
    options: [
  ...
  {
    id: 7,
    question: "Bila ada isu berkaitan Rojak...",
    options: [
  ...
  {
    id: 8,
    question: "Orang sekeliling describe anda dalam Rojak sebagai?",
    options: [
  ...
  {
    id: 9,
    question: "Future goals berkaitan Rojak?",
    options: [
  ...
  {
    id: 10,
    question: "Overall, Rojak untuk anda adalah?",
    options: [
...
export const results = {
  A: {
    type: "A",
    title: "Rojak Champion",
    emoji: "🥗",
    description: "Anda sangat cemerlang dalam Rojak! Passionate, dedicated, dan inspiring. Teruskan!",
  ...
  B: {
    ...
    title: "Rojak Pro",
    emoji: "⭐",
    description: "Anda balanced dan reliable dalam Rojak! Good approach dengan sustainable habits.",
  ...
  C: {
    ...
    title: "Rojak Casual",
    emoji: "😊",
    description: "Anda casual dengan Rojak. No stress approach, enjoy when it happens!",
  ...
  D: {
    ...
    title: "Rojak Newbie",
    emoji: "🌱",
    description: "Ruang untuk grow dalam Rojak! Everyone starts somewhere. Take your time!",
