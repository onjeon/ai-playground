// Gaya Hari Raya
// Bagaimana anda celebrate Raya?

export const questions = [
  {
    id: 1,
    question: "Bagaimana anda celebrate Raya?",
    options: [
