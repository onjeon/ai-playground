// Budaya Malu
// Berapa sensitif dengan malu?

export const questions = [
  {
    id: 1,
    question: "Berapa sensitif dengan malu?",
    options: [
