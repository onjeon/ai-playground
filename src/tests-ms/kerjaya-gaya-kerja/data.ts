...
export const questions = [
  {
    id: 1,
    question: "Soalan pertama tentang Gaya Kerja?",
    options: [
  ...
  {
    id: 2,
    question: "Bagaimana approach anda tentang Gaya Kerja?",
    options: [
  ...
  {
    id: 3,
    question: "Bila berkaitan Gaya Kerja, anda rasa?",
    options: [
  ...
  {
    id: 4,
    question: "Pengalaman anda dengan Gaya Kerja?",
    options: [
  ...
  {
    id: 5,
    question: "Dalam konteks Gaya Kerja, anda lebih...",
    options: [
  ...
  {
    id: 6,
    question: "Priority Gaya Kerja dalam hidup anda?",
    options: [
  ...
  {
    id: 7,
    question: "Bila ada isu berkaitan Gaya Kerja...",
    options: [
  ...
  {
    id: 8,
    question: "Orang sekeliling describe anda dalam Gaya Kerja sebagai?",
    options: [
  ...
  {
    id: 9,
    question: "Future goals berkaitan Gaya Kerja?",
    options: [
  ...
  {
    id: 10,
    question: "Overall, Gaya Kerja untuk anda adalah?",
    options: [
...
export const results = {
  A: {
    type: "A",
    title: "Gaya Kerja Champion",
    emoji: "💼",
    description: "Anda sangat cemerlang dalam Gaya Kerja! Passionate, dedicated, dan inspiring. Teruskan!",
  ...
  B: {
    type: "B",
    title: "Gaya Kerja Pro",
    emoji: "⭐",
    description: "Anda balanced dan reliable dalam Gaya Kerja! Good approach dengan sustainable habits.",
  ...
  C: {
    type: "C",
    title: "Gaya Kerja Casual",
    emoji: "😊",
    description: "Anda casual dengan Gaya Kerja. No stress approach, enjoy when it happens!",
  ...
  D: {
    type: "D",
    title: "Gaya Kerja Newbie",
    emoji: "🌱",
    description: "Ruang untuk grow dalam Gaya Kerja! Everyone starts somewhere. Take your time!",
