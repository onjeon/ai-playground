// Pendiam
// Sejauh mana anda pendiam?

export const questions = [
  {
    id: 1,
    question: "Soalan pertama tentang Pendiam?",
    options: [
  ...
  {
    id: 2,
    question: "Bagaimana approach anda tentang Pendiam?",
    options: [
  ...
  {
    id: 3,
    question: "Bila berkaitan Pendiam, anda rasa?",
    options: [
  ...
  {
    id: 4,
    question: "Pengalaman anda dengan Pendiam?",
    options: [
  ...
  {
    id: 5,
    question: "Dalam konteks Pendiam, anda lebih...",
    options: [
  ...
  {
    id: 6,
    question: "Priority Pendiam dalam hidup anda?",
    options: [
  ...
  {
    id: 7,
    question: "Bila ada isu berkaitan Pendiam...",
    options: [
  ...
  {
    id: 8,
    question: "Orang sekeliling describe anda dalam Pendiam sebagai?",
    options: [
  ...
  {
    id: 9,
    question: "Future goals berkaitan Pendiam?",
    options: [
  ...
  {
    id: 10,
    question: "Overall, Pendiam untuk anda adalah?",
    options: [
...
export const results = {
  A: {
    type: "A",
    title: "Pendiam Champion",
    emoji: "🤐",
    description: "Anda sangat cemerlang dalam Pendiam! Passionate, dedicated, dan inspiring. Teruskan!",
  ...
  B: {
    ...
    title: "Pendiam Pro",
    emoji: "⭐",
    description: "Anda balanced dan reliable dalam Pendiam! Good approach dengan sustainable habits.",
  ...
  C: {
    type: "C",
    title: "Pendiam Casual",
    emoji: "😊",
    description: "Anda casual dengan Pendiam. No stress approach, enjoy when it happens!",
  ...
  D: {
    type: "D",
    title: "Pendiam Newbie",
    emoji: "🌱",
    description: "Ruang untuk grow dalam Pendiam! Everyone starts somewhere. Take your time!",
