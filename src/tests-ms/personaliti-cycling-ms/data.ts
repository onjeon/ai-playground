...
export const questions = [
  {
    id: 1,
    question: "Soalan pertama tentang Cycling?",
    options: [
  ...
  {
    id: 2,
    question: "Bagaimana approach anda tentang Cycling?",
    options: [
  ...
  {
    id: 3,
    question: "Bila berkaitan Cycling, anda rasa?",
    options: [
  ...
  {
    id: 4,
    question: "Pengalaman anda dengan Cycling?",
    options: [
  ...
  {
    id: 5,
    question: "Dalam konteks Cycling, anda lebih...",
    options: [
  ...
  {
    id: 6,
    question: "Priority Cycling dalam hidup anda?",
    options: [
  ...
  {
    id: 7,
    question: "Bila ada isu berkaitan Cycling...",
    options: [
  ...
  {
    id: 8,
    question: "Orang sekeliling describe anda dalam Cycling sebagai?",
    options: [
  ...
  {
    id: 9,
    question: "Future goals berkaitan Cycling?",
    options: [
  ...
  {
    id: 10,
    question: "Overall, Cycling untuk anda adalah?",
    options: [
...
export const results = {
  A: {
    ...
    emoji: "🚴",
    description: "Anda sangat cemerlang dalam Cycling! Passionate, dedicated, dan inspiring. Teruskan!",
  ...
  B: {
    ...
    title: "Cycling Pro",
    emoji: "⭐",
    description: "Anda balanced dan reliable dalam Cycling! Good approach dengan sustainable habits.",
  ...
  C: {
    type: "C",
    title: "Cycling Casual",
    emoji: "😊",
    description: "Anda casual dengan Cycling. No stress approach, enjoy when it happens!",
  ...
  D: {
    type: "D",
    title: "Cycling Newbie",
    emoji: "🌱",
    description: "Ruang untuk grow dalam Cycling! Everyone starts somewhere. Take your time!",
