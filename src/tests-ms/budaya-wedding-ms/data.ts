// Gaya Wedding
// Bagaimana di majlis kahwin?

export const questions = [
  {
    id: 1,
    question: "Bagaimana di majlis kahwin?",
    options: [
