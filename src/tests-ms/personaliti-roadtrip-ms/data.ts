...
export const questions = [
  {
    id: 1,
    question: "Soalan pertama tentang Road Trip?",
    options: [
  ...
  {
    id: 2,
    question: "Bagaimana approach anda tentang Road Trip?",
    options: [
  ...
  {
    id: 3,
    question: "Bila berkaitan Road Trip, anda rasa?",
    options: [
  ...
  {
    id: 4,
    question: "Pengalaman anda dengan Road Trip?",
    options: [
  ...
  {
    id: 5,
    question: "Dalam konteks Road Trip, anda lebih...",
    options: [
  ...
  {
    id: 6,
    question: "Priority Road Trip dalam hidup anda?",
    options: [
  ...
  {
    id: 7,
    question: "Bila ada isu berkaitan Road Trip...",
    options: [
  ...
  {
    id: 8,
    question: "Orang sekeliling describe anda dalam Road Trip sebagai?",
    options: [
  ...
  {
    id: 9,
    question: "Future goals berkaitan Road Trip?",
    options: [
  ...
  {
    id: 10,
    question: "Overall, Road Trip untuk anda adalah?",
    options: [
...
export const results = {
  A: {
    type: "A",
    title: "Road Trip Champion",
    emoji: "🚗",
    description: "Anda sangat cemerlang dalam Road Trip! Passionate, dedicated, dan inspiring. Teruskan!",
  ...
  B: {
    ...
    title: "Road Trip Pro",
    emoji: "⭐",
    description: "Anda balanced dan reliable dalam Road Trip! Good approach dengan sustainable habits.",
  ...
  C: {
    type: "C",
    title: "Road Trip Casual",
    emoji: "😊",
    description: "Anda casual dengan Road Trip. No stress approach, enjoy when it happens!",
  ...
  D: {
    type: "D",
    title: "Road Trip Newbie",
    emoji: "🌱",
    description: "Ruang untuk grow dalam Road Trip! Everyone starts somewhere. Take your time!",
