...
export const questions = [
  {
    id: 1,
    question: "Soalan pertama tentang Minum?",
    options: [
  ...
  {
    id: 2,
    question: "Bagaimana approach anda tentang Minum?",
    options: [
  ...
  {
    id: 3,
    question: "Bila berkaitan Minum, anda rasa?",
    options: [
  ...
  {
    id: 4,
    question: "Pengalaman anda dengan Minum?",
    options: [
  ...
  {
    id: 5,
    question: "Dalam konteks Minum, anda lebih...",
    options: [
  ...
  {
    id: 6,
    question: "Priority Minum dalam hidup anda?",
    options: [
  ...
  {
    id: 7,
    question: "Bila ada isu berkaitan Minum...",
    options: [
  ...
  {
    id: 8,
    question: "Orang sekeliling describe anda dalam Minum sebagai?",
    options: [
  ...
  {
    id: 9,
    question: "Future goals berkaitan Minum?",
    options: [
  ...
  {
    id: 10,
    question: "Overall, Minum untuk anda adalah?",
    options: [
...
export const results = {
  A: {
    type: "A",
    title: "Minum Champion",
    emoji: "☕",
    description: "Anda sangat cemerlang dalam Minum! Passionate, dedicated, dan inspiring. Teruskan!",
  ...
  B: {
    ...
    title: "Minum Pro",
    emoji: "⭐",
    description: "Anda balanced dan reliable dalam Minum! Good approach dengan sustainable habits.",
  ...
  C: {
    ...
    title: "Minum Casual",
    emoji: "😊",
    description: "Anda casual dengan Minum. No stress approach, enjoy when it happens!",
  ...
  D: {
    ...
    title: "Minum Newbie",
    emoji: "🌱",
    description: "Ruang untuk grow dalam Minum! Everyone starts somewhere. Take your time!",
