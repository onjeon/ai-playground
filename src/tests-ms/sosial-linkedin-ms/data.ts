...
export const questions = [
  {
    id: 1,
    question: "Soalan pertama tentang LinkedIn?",
    options: [
  ...
  {
    id: 2,
    question: "Bagaimana approach anda tentang LinkedIn?",
    options: [
  ...
  {
    id: 3,
    question: "Bila berkaitan LinkedIn, anda rasa?",
    options: [
  ...
  {
    id: 4,
    question: "Pengalaman anda dengan LinkedIn?",
    options: [
  ...
  {
    id: 5,
    question: "Dalam konteks LinkedIn, anda lebih...",
    options: [
  ...
  {
    id: 6,
    question: "Priority LinkedIn dalam hidup anda?",
    options: [
  ...
  {
    id: 7,
    question: "Bila ada isu berkaitan LinkedIn...",
    options: [
  ...
  {
    id: 8,
    question: "Orang sekeliling describe anda dalam LinkedIn sebagai?",
    options: [
  ...
  {
    id: 9,
    question: "Future goals berkaitan LinkedIn?",
    options: [
  ...
  {
    id: 10,
    question: "Overall, LinkedIn untuk anda adalah?",
    options: [
...
export const results = {
  A: {
    type: "A",
    title: "LinkedIn Champion",
    emoji: "💼",
    description: "Anda sangat cemerlang dalam LinkedIn! Passionate, dedicated, dan inspiring. Teruskan!",
  ...
  B: {
    ...
    title: "LinkedIn Pro",
    emoji: "⭐",
    description: "Anda balanced dan reliable dalam LinkedIn! Good approach dengan sustainable habits.",
  ...
  C: {
    ...
    emoji: "😊",
    description: "Anda casual dengan LinkedIn. No stress approach, enjoy when it happens!",
  ...
  D: {
    type: "D",
    title: "LinkedIn Newbie",
    emoji: "🌱",
    description: "Ruang untuk grow dalam LinkedIn! Everyone starts somewhere. Take your time!",
