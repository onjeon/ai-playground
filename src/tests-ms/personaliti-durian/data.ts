// Durian
// Jenis durian lover anda?

export const questions = [
  {
    id: 1,
    question: "Soalan pertama tentang Durian?",
    options: [
  ...
  {
    id: 2,
    question: "Bagaimana approach anda tentang Durian?",
    options: [
  ...
  {
    id: 3,
    question: "Bila berkaitan Durian, anda rasa?",
    options: [
  ...
  {
    id: 4,
    question: "Pengalaman anda dengan Durian?",
    options: [
  ...
  {
    id: 5,
    question: "Dalam konteks Durian, anda lebih...",
    options: [
  ...
  {
    id: 6,
    question: "Priority Durian dalam hidup anda?",
    options: [
  ...
  {
    id: 7,
    question: "Bila ada isu berkaitan Durian...",
    options: [
  ...
  {
    id: 8,
    question: "Orang sekeliling describe anda dalam Durian sebagai?",
    options: [
  ...
  {
    id: 9,
    question: "Future goals berkaitan Durian?",
    options: [
  ...
  {
    id: 10,
    question: "Overall, Durian untuk anda adalah?",
    options: [
...
export const results = {
  A: {
    type: "A",
    title: "Durian Champion",
    emoji: "🥇",
    description: "Anda sangat cemerlang dalam Durian! Passionate, dedicated, dan inspiring. Teruskan!",
  ...
  B: {
    ...
    title: "Durian Pro",
    emoji: "⭐",
    description: "Anda balanced dan reliable dalam Durian! Good approach dengan sustainable habits.",
  ...
  C: {
    ...
    title: "Durian Casual",
    emoji: "😊",
    description: "Anda casual dengan Durian. No stress approach, enjoy when it happens!",
  ...
  D: {
    ...
    title: "Durian Newbie",
    emoji: "🌱",
    description: "Ruang untuk grow dalam Durian! Everyone starts somewhere. Take your time!",
