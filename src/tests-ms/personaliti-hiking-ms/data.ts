...
export const questions = [
  {
    id: 1,
    question: "Soalan pertama tentang Hiking?",
    options: [
  ...
  {
    id: 2,
    question: "Bagaimana approach anda tentang Hiking?",
    options: [
  ...
  {
    id: 3,
    question: "Bila berkaitan Hiking, anda rasa?",
    options: [
  ...
  {
    id: 4,
    question: "Pengalaman anda dengan Hiking?",
    options: [
  ...
  {
    id: 5,
    question: "Dalam konteks Hiking, anda lebih...",
    options: [
  ...
  {
    id: 6,
    question: "Priority Hiking dalam hidup anda?",
    options: [
  ...
  {
    id: 7,
    question: "Bila ada isu berkaitan Hiking...",
    options: [
  ...
  {
    id: 8,
    question: "Orang sekeliling describe anda dalam Hiking sebagai?",
    options: [
  ...
  {
    id: 9,
    question: "Future goals berkaitan Hiking?",
    options: [
  ...
  {
    id: 10,
    question: "Overall, Hiking untuk anda adalah?",
    options: [
...
export const results = {
  A: {
    ...
    emoji: "🥾",
    description: "Anda sangat cemerlang dalam Hiking! Passionate, dedicated, dan inspiring. Teruskan!",
  ...
  B: {
    ...
    title: "Hiking Pro",
    emoji: "⭐",
    description: "Anda balanced dan reliable dalam Hiking! Good approach dengan sustainable habits.",
  ...
  C: {
    ...
    title: "Hiking Casual",
    emoji: "😊",
    description: "Anda casual dengan Hiking. No stress approach, enjoy when it happens!",
  ...
  D: {
    ...
    title: "Hiking Newbie",
    emoji: "🌱",
    description: "Ruang untuk grow dalam Hiking! Everyone starts somewhere. Take your time!",
