// Gaya Open House
// Bagaimana buat open house?

export const questions = [
  {
    id: 1,
    question: "Bagaimana buat open house?",
    options: [
