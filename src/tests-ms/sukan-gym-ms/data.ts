...
export const questions = [
  {
    id: 1,
    question: "Soalan pertama tentang Gym?",
    options: [
  ...
  {
    id: 2,
    question: "Bagaimana approach anda tentang Gym?",
    options: [
  ...
  {
    id: 3,
    question: "Bila berkaitan Gym, anda rasa?",
    options: [
  ...
  {
    id: 4,
    question: "Pengalaman anda dengan Gym?",
    options: [
  ...
  {
    id: 5,
    question: "Dalam konteks Gym, anda lebih...",
    options: [
  ...
  {
    id: 6,
    question: "Priority Gym dalam hidup anda?",
    options: [
  ...
  {
    id: 7,
    question: "Bila ada isu berkaitan Gym...",
    options: [
  ...
  {
    id: 8,
    question: "Orang sekeliling describe anda dalam Gym sebagai?",
    options: [
  ...
  {
    id: 9,
    question: "Future goals berkaitan Gym?",
    options: [
  ...
  {
    id: 10,
    question: "Overall, Gym untuk anda adalah?",
    options: [
...
export const results = {
  A: {
    ...
    title: "Gym Champion",
    emoji: "🏋️",
    description: "Anda sangat cemerlang dalam Gym! Passionate, dedicated, dan inspiring. Teruskan!",
  ...
  B: {
    ...
    title: "Gym Pro",
    emoji: "⭐",
    description: "Anda balanced dan reliable dalam Gym! Good approach dengan sustainable habits.",
  ...
  C: {
    ...
    title: "Gym Casual",
    emoji: "😊",
    description: "Anda casual dengan Gym. No stress approach, enjoy when it happens!",
  ...
  D: {
    ...
    title: "Gym Newbie",
    emoji: "🌱",
    description: "Ruang untuk grow dalam Gym! Everyone starts somewhere. Take your time!",
