...
export const questions = [
  {
    id: 1,
    question: "Soalan pertama tentang Swimming?",
    options: [
  ...
  {
    id: 2,
    question: "Bagaimana approach anda tentang Swimming?",
    options: [
  ...
  {
    id: 3,
    question: "Bila berkaitan Swimming, anda rasa?",
    options: [
  ...
  {
    id: 4,
    question: "Pengalaman anda dengan Swimming?",
    options: [
  ...
  {
    id: 5,
    question: "Dalam konteks Swimming, anda lebih...",
    options: [
  ...
  {
    id: 6,
    question: "Priority Swimming dalam hidup anda?",
    options: [
  ...
  {
    id: 7,
    question: "Bila ada isu berkaitan Swimming...",
    options: [
  ...
  {
    id: 8,
    question: "Orang sekeliling describe anda dalam Swimming sebagai?",
    options: [
  ...
  {
    id: 9,
    question: "Future goals berkaitan Swimming?",
    options: [
  ...
  {
    id: 10,
    question: "Overall, Swimming untuk anda adalah?",
    options: [
...
export const results = {
  A: {
    ...
    emoji: "🏊",
    description: "Anda sangat cemerlang dalam Swimming! Passionate, dedicated, dan inspiring. Teruskan!",
  ...
  B: {
    ...
    title: "Swimming Pro",
    emoji: "⭐",
    description: "Anda balanced dan reliable dalam Swimming! Good approach dengan sustainable habits.",
  ...
  C: {
    type: "C",
    title: "Swimming Casual",
    emoji: "😊",
    description: "Anda casual dengan Swimming. No stress approach, enjoy when it happens!",
  ...
  D: {
    type: "D",
    title: "Swimming Newbie",
    emoji: "🌱",
    description: "Ruang untuk grow dalam Swimming! Everyone starts somewhere. Take your time!",
