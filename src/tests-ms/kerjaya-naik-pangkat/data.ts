// Potensi Naik Pangkat
// Sejauh mana promotion potential?

export const questions = [
  {
    id: 1,
    question: "Soalan pertama tentang Potensi Naik Pangkat?",
    options: [
  ...
  {
    id: 2,
    question: "Bagaimana approach anda tentang Potensi Naik Pangkat?",
    options: [
  ...
  {
    id: 3,
    question: "Bila berkaitan Potensi Naik Pangkat, anda rasa?",
    options: [
  ...
  {
    id: 4,
    question: "Pengalaman anda dengan Potensi Naik Pangkat?",
    options: [
  ...
  {
    id: 5,
    question: "Dalam konteks Potensi Naik Pangkat, anda lebih...",
    options: [
  ...
  {
    id: 6,
    question: "Priority Potensi Naik Pangkat dalam hidup anda?",
    options: [
  ...
  {
    id: 7,
    question: "Bila ada isu berkaitan Potensi Naik Pangkat...",
    options: [
  ...
  {
    id: 8,
    question: "Orang sekeliling describe anda dalam Potensi Naik Pangkat sebagai?",
    options: [
  ...
  {
    id: 9,
    question: "Future goals berkaitan Potensi Naik Pangkat?",
    options: [
  ...
  {
    id: 10,
    question: "Overall, Potensi Naik Pangkat untuk anda adalah?",
    options: [
...
export const results = {
  A: {
    type: "A",
    title: "Potensi Naik Pangkat Champion",
    emoji: "📈",
    description: "Anda sangat cemerlang dalam Potensi Naik Pangkat! Passionate, dedicated, dan inspiring. Teruskan!",
  ...
  B: {
    type: "B",
    title: "Potensi Naik Pangkat Pro",
    emoji: "⭐",
    description: "Anda balanced dan reliable dalam Potensi Naik Pangkat! Good approach dengan sustainable habits.",
  ...
  C: {
    type: "C",
    title: "Potensi Naik Pangkat Casual",
    emoji: "😊",
    description: "Anda casual dengan Potensi Naik Pangkat. No stress approach, enjoy when it happens!",
  ...
  D: {
    type: "D",
    title: "Potensi Naik Pangkat Newbie",
    emoji: "🌱",
    description: "Ruang untuk grow dalam Potensi Naik Pangkat! Everyone starts somewhere. Take your time!",
