...
export const questions = [
  {
    id: 1,
    question: "Soalan pertama tentang Internet?",
    options: [
  ...
  {
    id: 2,
    question: "Bagaimana approach anda tentang Internet?",
    options: [
  ...
  {
    id: 3,
    question: "Bila berkaitan Internet, anda rasa?",
    options: [
  ...
  {
    id: 4,
    question: "Pengalaman anda dengan Internet?",
    options: [
  ...
  {
    id: 5,
    question: "Dalam konteks Internet, anda lebih...",
    options: [
  ...
  {
    id: 6,
    question: "Priority Internet dalam hidup anda?",
    options: [
  ...
  {
    id: 7,
    question: "Bila ada isu berkaitan Internet...",
    options: [
  ...
  {
    id: 8,
    question: "Orang sekeliling describe anda dalam Internet sebagai?",
    options: [
  ...
  {
    id: 9,
    question: "Future goals berkaitan Internet?",
    options: [
  ...
  {
    id: 10,
    question: "Overall, Internet untuk anda adalah?",
    options: [
...
export const results = {
  A: {
    ...
    emoji: "🌐",
    description: "Anda sangat cemerlang dalam Internet! Passionate, dedicated, dan inspiring. Teruskan!",
  ...
  B: {
    ...
    title: "Internet Pro",
    emoji: "⭐",
    description: "Anda balanced dan reliable dalam Internet! Good approach dengan sustainable habits.",
  ...
  C: {
    type: "C",
    title: "Internet Casual",
    emoji: "😊",
    description: "Anda casual dengan Internet. No stress approach, enjoy when it happens!",
  ...
  D: {
    type: "D",
    title: "Internet Newbie",
    emoji: "🌱",
    description: "Ruang untuk grow dalam Internet! Everyone starts somewhere. Take your time!",
