// Gaya Kepimpinan
// Apa leadership style anda?

export const questions = [
  {
    id: 1,
    question: "Soalan pertama tentang Gaya Kepimpinan?",
    options: [
  ...
  {
    id: 2,
    question: "Bagaimana approach anda tentang Gaya Kepimpinan?",
    options: [
  ...
  {
    id: 3,
    question: "Bila berkaitan Gaya Kepimpinan, anda rasa?",
    options: [
  ...
  {
    id: 4,
    question: "Pengalaman anda dengan Gaya Kepimpinan?",
    options: [
  ...
  {
    id: 5,
    question: "Dalam konteks Gaya Kepimpinan, anda lebih...",
    options: [
  ...
  {
    id: 6,
    question: "Priority Gaya Kepimpinan dalam hidup anda?",
    options: [
  ...
  {
    id: 7,
    question: "Bila ada isu berkaitan Gaya Kepimpinan...",
    options: [
  ...
  {
    id: 8,
    question: "Orang sekeliling describe anda dalam Gaya Kepimpinan sebagai?",
    options: [
  ...
  {
    id: 9,
    question: "Future goals berkaitan Gaya Kepimpinan?",
    options: [
  ...
  {
    id: 10,
    question: "Overall, Gaya Kepimpinan untuk anda adalah?",
    options: [
...
export const results = {
  A: {
    type: "A",
    title: "Gaya Kepimpinan Champion",
    emoji: "👑",
    description: "Anda sangat cemerlang dalam Gaya Kepimpinan! Passionate, dedicated, dan inspiring. Teruskan!",
  ...
  B: {
    type: "B",
    title: "Gaya Kepimpinan Pro",
    emoji: "⭐",
    description: "Anda balanced dan reliable dalam Gaya Kepimpinan! Good approach dengan sustainable habits.",
  ...
  C: {
    type: "C",
    title: "Gaya Kepimpinan Casual",
    emoji: "😊",
    description: "Anda casual dengan Gaya Kepimpinan. No stress approach, enjoy when it happens!",
  ...
  D: {
    type: "D",
    title: "Gaya Kepimpinan Newbie",
    emoji: "🌱",
    description: "Ruang untuk grow dalam Gaya Kepimpinan! Everyone starts somewhere. Take your time!",
