...
export const questions = [
  {
    id: 1,
    question: "Soalan pertama tentang E-Wallet?",
    options: [
  ...
  {
    id: 2,
    question: "Bagaimana approach anda tentang E-Wallet?",
    options: [
  ...
  {
    id: 3,
    question: "Bila berkaitan E-Wallet, anda rasa?",
    options: [
  ...
  {
    id: 4,
    question: "Pengalaman anda dengan E-Wallet?",
    options: [
  ...
  {
    id: 5,
    question: "Dalam konteks E-Wallet, anda lebih...",
    options: [
  ...
  {
    id: 6,
    question: "Priority E-Wallet dalam hidup anda?",
    options: [
  ...
  {
    id: 7,
    question: "Bila ada isu berkaitan E-Wallet...",
    options: [
  ...
  {
    id: 8,
    question: "Orang sekeliling describe anda dalam E-Wallet sebagai?",
    options: [
  ...
  {
    id: 9,
    question: "Future goals berkaitan E-Wallet?",
    options: [
  ...
  {
    id: 10,
    question: "Overall, E-Wallet untuk anda adalah?",
    options: [
...
export const results = {
  A: {
    type: "A",
    title: "E-Wallet Champion",
    emoji: "💳",
    description: "Anda sangat cemerlang dalam E-Wallet! Passionate, dedicated, dan inspiring. Teruskan!",
  ...
  B: {
    ...
    title: "E-Wallet Pro",
    emoji: "⭐",
    description: "Anda balanced dan reliable dalam E-Wallet! Good approach dengan sustainable habits.",
  ...
  C: {
    type: "C",
    title: "E-Wallet Casual",
    emoji: "😊",
    description: "Anda casual dengan E-Wallet. No stress approach, enjoy when it happens!",
  ...
  D: {
    type: "D",
    title: "E-Wallet Newbie",
    emoji: "🌱",
    description: "Ruang untuk grow dalam E-Wallet! Everyone starts somewhere. Take your time!",
