// Gaya CNY
// Bagaimana anda celebrate CNY?

export const questions = [
  {
    id: 1,
    question: "Bagaimana anda celebrate CNY?",
    options: [
