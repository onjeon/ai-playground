...
export const questions = [
  {
    id: 1,
    question: "Soalan pertama tentang Deepavali?",
    options: [
  ...
  {
    id: 2,
    question: "Bagaimana approach anda tentang Deepavali?",
    options: [
  ...
  {
    id: 3,
    question: "Bila berkaitan Deepavali, anda rasa?",
    options: [
  ...
  {
    id: 4,
    question: "Pengalaman anda dengan Deepavali?",
    options: [
  ...
  {
    id: 5,
    question: "Dalam konteks Deepavali, anda lebih...",
    options: [
  ...
  {
    id: 6,
    question: "Priority Deepavali dalam hidup anda?",
    options: [
  ...
  {
    id: 7,
    question: "Bila ada isu berkaitan Deepavali...",
    options: [
  ...
  {
    id: 8,
    question: "Orang sekeliling describe anda dalam Deepavali sebagai?",
    options: [
  ...
  {
    id: 9,
    question: "Future goals berkaitan Deepavali?",
    options: [
  ...
  {
    id: 10,
    question: "Overall, Deepavali untuk anda adalah?",
    options: [
...
export const results = {
  A: {
    type: "A",
    title: "Deepavali Champion",
    emoji: "🪔",
    description: "Anda sangat cemerlang dalam Deepavali! Passionate, dedicated, dan inspiring. Teruskan!",
  ...
  B: {
    ...
    title: "Deepavali Pro",
    emoji: "⭐",
    description: "Anda balanced dan reliable dalam Deepavali! Good approach dengan sustainable habits.",
  ...
  C: {
    type: "C",
    title: "Deepavali Casual",
    emoji: "😊",
    description: "Anda casual dengan Deepavali. No stress approach, enjoy when it happens!",
  ...
  D: {
    type: "D",
    title: "Deepavali Newbie",
    emoji: "🌱",
    description: "Ruang untuk grow dalam Deepavali! Everyone starts somewhere. Take your time!",
