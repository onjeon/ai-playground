...
export const questions = [
  {
    id: 1,
    question: "Soalan pertama tentang Badminton?",
    options: [
  ...
  {
    id: 2,
    question: "Bagaimana approach anda tentang Badminton?",
    options: [
  ...
  {
    id: 3,
    question: "Bila berkaitan Badminton, anda rasa?",
    options: [
  ...
  {
    id: 4,
    question: "Pengalaman anda dengan Badminton?",
    options: [
  ...
  {
    id: 5,
    question: "Dalam konteks Badminton, anda lebih...",
    options: [
  ...
  {
    id: 6,
    question: "Priority Badminton dalam hidup anda?",
    options: [
  ...
  {
    id: 7,
    question: "Bila ada isu berkaitan Badminton...",
    options: [
  ...
  {
    id: 8,
    question: "Orang sekeliling describe anda dalam Badminton sebagai?",
    options: [
  ...
  {
    id: 9,
    question: "Future goals berkaitan Badminton?",
    options: [
  ...
  {
    id: 10,
    question: "Overall, Badminton untuk anda adalah?",
    options: [
...
export const results = {
  A: {
    ...
    emoji: "🏸",
    description: "Anda sangat cemerlang dalam Badminton! Passionate, dedicated, dan inspiring. Teruskan!",
  ...
  B: {
    ...
    title: "Badminton Pro",
    emoji: "⭐",
    description: "Anda balanced dan reliable dalam Badminton! Good approach dengan sustainable habits.",
  ...
  C: {
    ...
    emoji: "😊",
    description: "Anda casual dengan Badminton. No stress approach, enjoy when it happens!",
  ...
  D: {
    type: "D",
    title: "Badminton Newbie",
    emoji: "🌱",
    description: "Ruang untuk grow dalam Badminton! Everyone starts somewhere. Take your time!",
