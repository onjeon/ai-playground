// Cerewet
// Sejauh mana anda cerewet?

export const questions = [
  {
    id: 1,
    question: "Soalan pertama tentang Cerewet?",
    options: [
  ...
  {
    id: 2,
    question: "Bagaimana approach anda tentang Cerewet?",
    options: [
  ...
  {
    id: 3,
    question: "Bila berkaitan Cerewet, anda rasa?",
    options: [
  ...
  {
    id: 4,
    question: "Pengalaman anda dengan Cerewet?",
    options: [
  ...
  {
    id: 5,
    question: "Dalam konteks Cerewet, anda lebih...",
    options: [
  ...
  {
    id: 6,
    question: "Priority Cerewet dalam hidup anda?",
    options: [
  ...
  {
    id: 7,
    question: "Bila ada isu berkaitan Cerewet...",
    options: [
  ...
  {
    id: 8,
    question: "Orang sekeliling describe anda dalam Cerewet sebagai?",
    options: [
  ...
  {
    id: 9,
    question: "Future goals berkaitan Cerewet?",
    options: [
  ...
  {
    id: 10,
    question: "Overall, Cerewet untuk anda adalah?",
    options: [
...
export const results = {
  A: {
    type: "A",
    title: "Cerewet Champion",
    emoji: "😤",
    description: "Anda sangat cemerlang dalam Cerewet! Passionate, dedicated, dan inspiring. Teruskan!",
  ...
  B: {
    ...
    title: "Cerewet Pro",
    emoji: "⭐",
    description: "Anda balanced dan reliable dalam Cerewet! Good approach dengan sustainable habits.",
  ...
  C: {
    type: "C",
    title: "Cerewet Casual",
    emoji: "😊",
    description: "Anda casual dengan Cerewet. No stress approach, enjoy when it happens!",
  ...
  D: {
    type: "D",
    title: "Cerewet Newbie",
    emoji: "🌱",
    description: "Ruang untuk grow dalam Cerewet! Everyone starts somewhere. Take your time!",
