...
export const questions = [
  {
    id: 1,
    question: "Soalan pertama tentang Renang?",
    options: [
  ...
  {
    id: 2,
    question: "Bagaimana approach anda tentang Renang?",
    options: [
  ...
  {
    id: 3,
    question: "Bila berkaitan Renang, anda rasa?",
    options: [
  ...
  {
    id: 4,
    question: "Pengalaman anda dengan Renang?",
    options: [
  ...
  {
    id: 5,
    question: "Dalam konteks Renang, anda lebih...",
    options: [
  ...
  {
    id: 6,
    question: "Priority Renang dalam hidup anda?",
    options: [
  ...
  {
    id: 7,
    question: "Bila ada isu berkaitan Renang...",
    options: [
  ...
  {
    id: 8,
    question: "Orang sekeliling describe anda dalam Renang sebagai?",
    options: [
  ...
  {
    id: 9,
    question: "Future goals berkaitan Renang?",
    options: [
  ...
  {
    id: 10,
    question: "Overall, Renang untuk anda adalah?",
    options: [
...
export const results = {
  A: {
    type: "A",
    title: "Renang Champion",
    emoji: "🏊",
    description: "Anda sangat cemerlang dalam Renang! Passionate, dedicated, dan inspiring. Teruskan!",
  ...
  B: {
    ...
    title: "Renang Pro",
    emoji: "⭐",
    description: "Anda balanced dan reliable dalam Renang! Good approach dengan sustainable habits.",
  ...
  C: {
    ...
    title: "Renang Casual",
    emoji: "😊",
    description: "Anda casual dengan Renang. No stress approach, enjoy when it happens!",
  ...
  D: {
    ...
    title: "Renang Newbie",
    emoji: "🌱",
    description: "Ruang untuk grow dalam Renang! Everyone starts somewhere. Take your time!",
