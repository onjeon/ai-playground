// Smartphone
// Gaya smartphone anda?

export const questions = [
  {
    id: 1,
    question: "Soalan pertama tentang Smartphone?",
    options: [
  ...
  {
    id: 2,
    question: "Bagaimana approach anda tentang Smartphone?",
    options: [
  ...
  {
    id: 3,
    question: "Bila berkaitan Smartphone, anda rasa?",
    options: [
  ...
  {
    id: 4,
    question: "Pengalaman anda dengan Smartphone?",
    options: [
  ...
  {
    id: 5,
    question: "Dalam konteks Smartphone, anda lebih...",
    options: [
  ...
  {
    id: 6,
    question: "Priority Smartphone dalam hidup anda?",
    options: [
  ...
  {
    id: 7,
    question: "Bila ada isu berkaitan Smartphone...",
    options: [
  ...
  {
    id: 8,
    question: "Orang sekeliling describe anda dalam Smartphone sebagai?",
    options: [
  ...
  {
    id: 9,
    question: "Future goals berkaitan Smartphone?",
    options: [
  ...
  {
    id: 10,
    question: "Overall, Smartphone untuk anda adalah?",
    options: [
...
export const results = {
  A: {
    type: "A",
    title: "Smartphone Champion",
    emoji: "📱",
    description: "Anda sangat cemerlang dalam Smartphone! Passionate, dedicated, dan inspiring. Teruskan!",
  ...
  B: {
    ...
    emoji: "⭐",
    description: "Anda balanced dan reliable dalam Smartphone! Good approach dengan sustainable habits.",
  ...
  C: {
    type: "C",
    title: "Smartphone Casual",
    emoji: "😊",
    description: "Anda casual dengan Smartphone. No stress approach, enjoy when it happens!",
  ...
  D: {
    type: "D",
    title: "Smartphone Newbie",
    emoji: "🌱",
    description: "Ruang untuk grow dalam Smartphone! Everyone starts somewhere. Take your time!",
