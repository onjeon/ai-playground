...
export const questions = [
  {
    id: 1,
    question: "Soalan pertama tentang Laptop?",
    options: [
  ...
  {
    id: 2,
    question: "Bagaimana approach anda tentang Laptop?",
    options: [
  ...
  {
    id: 3,
    question: "Bila berkaitan Laptop, anda rasa?",
    options: [
  ...
  {
    id: 4,
    question: "Pengalaman anda dengan Laptop?",
    options: [
  ...
  {
    id: 5,
    question: "Dalam konteks Laptop, anda lebih...",
    options: [
  ...
  {
    id: 6,
    question: "Priority Laptop dalam hidup anda?",
    options: [
  ...
  {
    id: 7,
    question: "Bila ada isu berkaitan Laptop...",
    options: [
  ...
  {
    id: 8,
    question: "Orang sekeliling describe anda dalam Laptop sebagai?",
    options: [
  ...
  {
    id: 9,
    question: "Future goals berkaitan Laptop?",
    options: [
  ...
  {
    id: 10,
    question: "Overall, Laptop untuk anda adalah?",
    options: [
...
export const results = {
  A: {
    type: "A",
    title: "Laptop Champion",
    emoji: "💻",
    description: "Anda sangat cemerlang dalam Laptop! Passionate, dedicated, dan inspiring. Teruskan!",
  ...
  B: {
    ...
    title: "Laptop Pro",
    emoji: "⭐",
    description: "Anda balanced dan reliable dalam Laptop! Good approach dengan sustainable habits.",
  ...
  C: {
    ...
    title: "Laptop Casual",
    emoji: "😊",
    description: "Anda casual dengan Laptop. No stress approach, enjoy when it happens!",
  ...
  D: {
    ...
    title: "Laptop Newbie",
    emoji: "🌱",
    description: "Ruang untuk grow dalam Laptop! Everyone starts somewhere. Take your time!",
