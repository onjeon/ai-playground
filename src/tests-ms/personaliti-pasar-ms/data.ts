...
export const questions = [
  {
    id: 1,
    question: "Soalan pertama tentang Pasar?",
    options: [
  ...
  {
    id: 2,
    question: "Bagaimana approach anda tentang Pasar?",
    options: [
  ...
  {
    id: 3,
    question: "Bila berkaitan Pasar, anda rasa?",
    options: [
  ...
  {
    id: 4,
    question: "Pengalaman anda dengan Pasar?",
    options: [
  ...
  {
    id: 5,
    question: "Dalam konteks Pasar, anda lebih...",
    options: [
  ...
  {
    id: 6,
    question: "Priority Pasar dalam hidup anda?",
    options: [
  ...
  {
    id: 7,
    question: "Bila ada isu berkaitan Pasar...",
    options: [
  ...
  {
    id: 8,
    question: "Orang sekeliling describe anda dalam Pasar sebagai?",
    options: [
  ...
  {
    id: 9,
    question: "Future goals berkaitan Pasar?",
    options: [
  ...
  {
    id: 10,
    question: "Overall, Pasar untuk anda adalah?",
    options: [
...
export const results = {
  A: {
    type: "A",
    title: "Pasar Champion",
    emoji: "🛒",
    description: "Anda sangat cemerlang dalam Pasar! Passionate, dedicated, dan inspiring. Teruskan!",
  ...
  B: {
    ...
    title: "Pasar Pro",
    emoji: "⭐",
    description: "Anda balanced dan reliable dalam Pasar! Good approach dengan sustainable habits.",
  ...
  C: {
    ...
    title: "Pasar Casual",
    emoji: "😊",
    description: "Anda casual dengan Pasar. No stress approach, enjoy when it happens!",
  ...
  D: {
    ...
    title: "Pasar Newbie",
    emoji: "🌱",
    description: "Ruang untuk grow dalam Pasar! Everyone starts somewhere. Take your time!",
