...
export const questions = [
  {
    id: 1,
    question: "Soalan pertama tentang Cinema?",
    options: [
  ...
  {
    id: 2,
    question: "Bagaimana approach anda tentang Cinema?",
    options: [
  ...
  {
    id: 3,
    question: "Bila berkaitan Cinema, anda rasa?",
    options: [
  ...
  {
    id: 4,
    question: "Pengalaman anda dengan Cinema?",
    options: [
  ...
  {
    id: 5,
    question: "Dalam konteks Cinema, anda lebih...",
    options: [
  ...
  {
    id: 6,
    question: "Priority Cinema dalam hidup anda?",
    options: [
  ...
  {
    id: 7,
    question: "Bila ada isu berkaitan Cinema...",
    options: [
  ...
  {
    id: 8,
    question: "Orang sekeliling describe anda dalam Cinema sebagai?",
    options: [
  ...
  {
    id: 9,
    question: "Future goals berkaitan Cinema?",
    options: [
  ...
  {
    id: 10,
    question: "Overall, Cinema untuk anda adalah?",
    options: [
...
export const results = {
  A: {
    type: "A",
    title: "Cinema Champion",
    emoji: "🎬",
    description: "Anda sangat cemerlang dalam Cinema! Passionate, dedicated, dan inspiring. Teruskan!",
  ...
  B: {
    ...
    title: "Cinema Pro",
    emoji: "⭐",
    description: "Anda balanced dan reliable dalam Cinema! Good approach dengan sustainable habits.",
  ...
  C: {
    ...
    title: "Cinema Casual",
    emoji: "😊",
    description: "Anda casual dengan Cinema. No stress approach, enjoy when it happens!",
  ...
  D: {
    ...
    title: "Cinema Newbie",
    emoji: "🌱",
    description: "Ruang untuk grow dalam Cinema! Everyone starts somewhere. Take your time!",
