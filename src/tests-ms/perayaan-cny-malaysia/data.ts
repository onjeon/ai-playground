// CNY Malaysia
// Gaya Chinese New Year anda?

export const questions = [
  {
    id: 1,
    question: "Soalan pertama tentang CNY Malaysia?",
    options: [
  ...
  {
    id: 2,
    question: "Bagaimana approach anda tentang CNY Malaysia?",
    options: [
  ...
  {
    id: 3,
    question: "Bila berkaitan CNY Malaysia, anda rasa?",
    options: [
  ...
  {
    id: 4,
    question: "Pengalaman anda dengan CNY Malaysia?",
    options: [
  ...
  {
    id: 5,
    question: "Dalam konteks CNY Malaysia, anda lebih...",
    options: [
  ...
  {
    id: 6,
    question: "Priority CNY Malaysia dalam hidup anda?",
    options: [
  ...
  {
    id: 7,
    question: "Bila ada isu berkaitan CNY Malaysia...",
    options: [
  ...
  {
    id: 8,
    question: "Orang sekeliling describe anda dalam CNY Malaysia sebagai?",
    options: [
  ...
  {
    id: 9,
    question: "Future goals berkaitan CNY Malaysia?",
    options: [
  ...
  {
    id: 10,
    question: "Overall, CNY Malaysia untuk anda adalah?",
    options: [
...
export const results = {
  A: {
    type: "A",
    title: "CNY Malaysia Champion",
    emoji: "🧧",
    description: "Anda sangat cemerlang dalam CNY Malaysia! Passionate, dedicated, dan inspiring. Teruskan!",
  ...
  B: {
    type: "B",
    title: "CNY Malaysia Pro",
    emoji: "⭐",
    description: "Anda balanced dan reliable dalam CNY Malaysia! Good approach dengan sustainable habits.",
  ...
  C: {
    type: "C",
    title: "CNY Malaysia Casual",
    emoji: "😊",
    description: "Anda casual dengan CNY Malaysia. No stress approach, enjoy when it happens!",
  ...
  D: {
    type: "D",
    title: "CNY Malaysia Newbie",
    emoji: "🌱",
    description: "Ruang untuk grow dalam CNY Malaysia! Everyone starts somewhere. Take your time!",
