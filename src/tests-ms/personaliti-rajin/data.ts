// Rajin
// Sejauh mana anda rajin?

export const questions = [
  {
    id: 1,
    question: "Soalan pertama tentang Rajin?",
    options: [
  ...
  {
    id: 2,
    question: "Bagaimana approach anda tentang Rajin?",
    options: [
  ...
  {
    id: 3,
    question: "Bila berkaitan Rajin, anda rasa?",
    options: [
  ...
  {
    id: 4,
    question: "Pengalaman anda dengan Rajin?",
    options: [
  ...
  {
    id: 5,
    question: "Dalam konteks Rajin, anda lebih...",
    options: [
  ...
  {
    id: 6,
    question: "Priority Rajin dalam hidup anda?",
    options: [
  ...
  {
    id: 7,
    question: "Bila ada isu berkaitan Rajin...",
    options: [
  ...
  {
    id: 8,
    question: "Orang sekeliling describe anda dalam Rajin sebagai?",
    options: [
  ...
  {
    id: 9,
    question: "Future goals berkaitan Rajin?",
    options: [
  ...
  {
    id: 10,
    question: "Overall, Rajin untuk anda adalah?",
    options: [
...
export const results = {
  A: {
    type: "A",
    title: "Rajin Champion",
    emoji: "💪",
    description: "Anda sangat cemerlang dalam Rajin! Passionate, dedicated, dan inspiring. Teruskan!",
  ...
  B: {
    ...
    title: "Rajin Pro",
    emoji: "⭐",
    description: "Anda balanced dan reliable dalam Rajin! Good approach dengan sustainable habits.",
  ...
  C: {
    ...
    title: "Rajin Casual",
    emoji: "😊",
    description: "Anda casual dengan Rajin. No stress approach, enjoy when it happens!",
  ...
  D: {
    ...
    title: "Rajin Newbie",
    emoji: "🌱",
    description: "Ruang untuk grow dalam Rajin! Everyone starts somewhere. Take your time!",
