...
export const questions = [
  {
    id: 1,
    question: "Soalan pertama tentang Music?",
    options: [
  ...
  {
    id: 2,
    question: "Bagaimana approach anda tentang Music?",
    options: [
  ...
  {
    id: 3,
    question: "Bila berkaitan Music, anda rasa?",
    options: [
  ...
  {
    id: 4,
    question: "Pengalaman anda dengan Music?",
    options: [
  ...
  {
    id: 5,
    question: "Dalam konteks Music, anda lebih...",
    options: [
  ...
  {
    id: 6,
    question: "Priority Music dalam hidup anda?",
    options: [
  ...
  {
    id: 7,
    question: "Bila ada isu berkaitan Music...",
    options: [
  ...
  {
    id: 8,
    question: "Orang sekeliling describe anda dalam Music sebagai?",
    options: [
  ...
  {
    id: 9,
    question: "Future goals berkaitan Music?",
    options: [
  ...
  {
    id: 10,
    question: "Overall, Music untuk anda adalah?",
    options: [
...
export const results = {
  A: {
    ...
    emoji: "🎵",
    description: "Anda sangat cemerlang dalam Music! Passionate, dedicated, dan inspiring. Teruskan!",
  ...
  B: {
    ...
    title: "Music Pro",
    emoji: "⭐",
    description: "Anda balanced dan reliable dalam Music! Good approach dengan sustainable habits.",
  ...
  C: {
    ...
    title: "Music Casual",
    emoji: "😊",
    description: "Anda casual dengan Music. No stress approach, enjoy when it happens!",
  ...
  D: {
    ...
    title: "Music Newbie",
    emoji: "🌱",
    description: "Ruang untuk grow dalam Music! Everyone starts somewhere. Take your time!",
