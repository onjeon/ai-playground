...
export const questions = [
  {
    id: 1,
    question: "Soalan pertama tentang Jogging?",
    options: [
  ...
  {
    id: 2,
    question: "Bagaimana approach anda tentang Jogging?",
    options: [
  ...
  {
    id: 3,
    question: "Bila berkaitan Jogging, anda rasa?",
    options: [
  ...
  {
    id: 4,
    question: "Pengalaman anda dengan Jogging?",
    options: [
  ...
  {
    id: 5,
    question: "Dalam konteks Jogging, anda lebih...",
    options: [
  ...
  {
    id: 6,
    question: "Priority Jogging dalam hidup anda?",
    options: [
  ...
  {
    id: 7,
    question: "Bila ada isu berkaitan Jogging...",
    options: [
  ...
  {
    id: 8,
    question: "Orang sekeliling describe anda dalam Jogging sebagai?",
    options: [
  ...
  {
    id: 9,
    question: "Future goals berkaitan Jogging?",
    options: [
  ...
  {
    id: 10,
    question: "Overall, Jogging untuk anda adalah?",
    options: [
...
export const results = {
  A: {
    type: "A",
    title: "Jogging Champion",
    emoji: "🏃",
    description: "Anda sangat cemerlang dalam Jogging! Passionate, dedicated, dan inspiring. Teruskan!",
  ...
  B: {
    ...
    title: "Jogging Pro",
    emoji: "⭐",
    description: "Anda balanced dan reliable dalam Jogging! Good approach dengan sustainable habits.",
  ...
  C: {
    type: "C",
    title: "Jogging Casual",
    emoji: "😊",
    description: "Anda casual dengan Jogging. No stress approach, enjoy when it happens!",
  ...
  D: {
    type: "D",
    title: "Jogging Newbie",
    emoji: "🌱",
    description: "Ruang untuk grow dalam Jogging! Everyone starts somewhere. Take your time!",
