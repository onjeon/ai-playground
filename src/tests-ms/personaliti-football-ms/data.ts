// Football
// Gaya football fan anda?

export const questions = [
  {
    id: 1,
    question: "Soalan pertama tentang Football?",
    options: [
  ...
  {
    id: 2,
    question: "Bagaimana approach anda tentang Football?",
    options: [
  ...
  {
    id: 3,
    question: "Bila berkaitan Football, anda rasa?",
    options: [
  ...
  {
    id: 4,
    question: "Pengalaman anda dengan Football?",
    options: [
  ...
  {
    id: 5,
    question: "Dalam konteks Football, anda lebih...",
    options: [
  ...
  {
    id: 6,
    question: "Priority Football dalam hidup anda?",
    options: [
  ...
  {
    id: 7,
    question: "Bila ada isu berkaitan Football...",
    options: [
  ...
  {
    id: 8,
    question: "Orang sekeliling describe anda dalam Football sebagai?",
    options: [
  ...
  {
    id: 9,
    question: "Future goals berkaitan Football?",
    options: [
  ...
  {
    id: 10,
    question: "Overall, Football untuk anda adalah?",
    options: [
...
export const results = {
  A: {
    ...
    emoji: "⚽",
    description: "Anda sangat cemerlang dalam Football! Passionate, dedicated, dan inspiring. Teruskan!",
  ...
  B: {
    ...
    title: "Football Pro",
    emoji: "⭐",
    description: "Anda balanced dan reliable dalam Football! Good approach dengan sustainable habits.",
  ...
  C: {
    type: "C",
    title: "Football Casual",
    emoji: "😊",
    description: "Anda casual dengan Football. No stress approach, enjoy when it happens!",
  ...
  D: {
    type: "D",
    title: "Football Newbie",
    emoji: "🌱",
    description: "Ruang untuk grow dalam Football! Everyone starts somewhere. Take your time!",
