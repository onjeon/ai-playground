...
export const questions = [
  {
    id: 1,
    question: "Soalan pertama tentang Raya Aidilfitri?",
    options: [
  ...
  {
    id: 2,
    question: "Bagaimana approach anda tentang Raya Aidilfitri?",
    options: [
  ...
  {
    id: 3,
    question: "Bila berkaitan Raya Aidilfitri, anda rasa?",
    options: [
  ...
  {
    id: 4,
    question: "Pengalaman anda dengan Raya Aidilfitri?",
    options: [
  ...
  {
    id: 5,
    question: "Dalam konteks Raya Aidilfitri, anda lebih...",
    options: [
  ...
  {
    id: 6,
    question: "Priority Raya Aidilfitri dalam hidup anda?",
    options: [
  ...
  {
    id: 7,
    question: "Bila ada isu berkaitan Raya Aidilfitri...",
    options: [
  ...
  {
    id: 8,
    question: "Orang sekeliling describe anda dalam Raya Aidilfitri sebagai?",
    options: [
  ...
  {
    id: 9,
    question: "Future goals berkaitan Raya Aidilfitri?",
    options: [
  ...
  {
    id: 10,
    question: "Overall, Raya Aidilfitri untuk anda adalah?",
    options: [
...
export const results = {
  A: {
    type: "A",
    title: "Raya Aidilfitri Champion",
    emoji: "🕌",
    description: "Anda sangat cemerlang dalam Raya Aidilfitri! Passionate, dedicated, dan inspiring. Teruskan!",
  ...
  B: {
    type: "B",
    title: "Raya Aidilfitri Pro",
    emoji: "⭐",
    description: "Anda balanced dan reliable dalam Raya Aidilfitri! Good approach dengan sustainable habits.",
  ...
  C: {
    type: "C",
    title: "Raya Aidilfitri Casual",
    emoji: "😊",
    description: "Anda casual dengan Raya Aidilfitri. No stress approach, enjoy when it happens!",
  ...
  D: {
    type: "D",
    title: "Raya Aidilfitri Newbie",
    emoji: "🌱",
    description: "Ruang untuk grow dalam Raya Aidilfitri! Everyone starts somewhere. Take your time!",
