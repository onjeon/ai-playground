// Personaliti Shopping Mall
// Bagaimana anda di mall?

export const questions = [
  {
    id: 1,
    question: "Bagaimana anda di mall?",
    options: [
...
export const results = {
  A: {
    type: "A",
    title: "Personaliti Shopping Mall Jenis A",
    emoji: "🔥",
  ...
  B: {
    type: "B",
    title: "Personaliti Shopping Mall Jenis B",
    emoji: "⚖️",
  ...
  C: {
    type: "C",
    title: "Personaliti Shopping Mall Jenis C",
    emoji: "😌",
  ...
  D: {
    type: "D",
    title: "Personaliti Shopping Mall Jenis D",
    emoji: "🌊",
