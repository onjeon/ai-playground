// Garang
// Sejauh mana anda garang?

export const questions = [
  {
    id: 1,
    question: "Soalan pertama tentang Garang?",
    options: [
  ...
  {
    id: 2,
    question: "Bagaimana approach anda tentang Garang?",
    options: [
  ...
  {
    id: 3,
    question: "Bila berkaitan Garang, anda rasa?",
    options: [
  ...
  {
    id: 4,
    question: "Pengalaman anda dengan Garang?",
    options: [
  ...
  {
    id: 5,
    question: "Dalam konteks Garang, anda lebih...",
    options: [
  ...
  {
    id: 6,
    question: "Priority Garang dalam hidup anda?",
    options: [
  ...
  {
    id: 7,
    question: "Bila ada isu berkaitan Garang...",
    options: [
  ...
  {
    id: 8,
    question: "Orang sekeliling describe anda dalam Garang sebagai?",
    options: [
  ...
  {
    id: 9,
    question: "Future goals berkaitan Garang?",
    options: [
  ...
  {
    id: 10,
    question: "Overall, Garang untuk anda adalah?",
    options: [
...
export const results = {
  A: {
    type: "A",
    title: "Garang Champion",
    emoji: "😠",
    description: "Anda sangat cemerlang dalam Garang! Passionate, dedicated, dan inspiring. Teruskan!",
  ...
  B: {
    ...
    title: "Garang Pro",
    emoji: "⭐",
    description: "Anda balanced dan reliable dalam Garang! Good approach dengan sustainable habits.",
  ...
  C: {
    ...
    title: "Garang Casual",
    emoji: "😊",
    description: "Anda casual dengan Garang. No stress approach, enjoy when it happens!",
  ...
  D: {
    ...
    title: "Garang Newbie",
    emoji: "🌱",
    description: "Ruang untuk grow dalam Garang! Everyone starts somewhere. Take your time!",
