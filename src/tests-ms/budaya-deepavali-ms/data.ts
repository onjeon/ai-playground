// Gaya Deepavali
// Bagaimana anda celebrate Deepavali?

export const questions = [
  {
    id: 1,
    question: "Bagaimana anda celebrate Deepavali?",
    options: [
