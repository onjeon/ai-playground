// Personaliti Pasar Malam
// Bagaimana anda di pasar malam?

export const questions = [
  {
    id: 1,
    question: "Bagaimana anda di pasar malam?",
    options: [
...
export const results = {
  A: {
    type: "A",
    title: "Personaliti Pasar Malam Jenis A",
    emoji: "🔥",
  ...
  B: {
    type: "B",
    title: "Personaliti Pasar Malam Jenis B",
    emoji: "⚖️",
  ...
  C: {
    type: "C",
    title: "Personaliti Pasar Malam Jenis C",
    emoji: "😌",
  ...
  D: {
    type: "D",
    title: "Personaliti Pasar Malam Jenis D",
    emoji: "🌊",
