...
export const questions = [
  {
    id: 1,
    question: "Soalan pertama tentang Mall?",
    options: [
  ...
  {
    id: 2,
    question: "Bagaimana approach anda tentang Mall?",
    options: [
  ...
  {
    id: 3,
    question: "Bila berkaitan Mall, anda rasa?",
    options: [
  ...
  {
    id: 4,
    question: "Pengalaman anda dengan Mall?",
    options: [
  ...
  {
    id: 5,
    question: "Dalam konteks Mall, anda lebih...",
    options: [
  ...
  {
    id: 6,
    question: "Priority Mall dalam hidup anda?",
    options: [
  ...
  {
    id: 7,
    question: "Bila ada isu berkaitan Mall...",
    options: [
  ...
  {
    id: 8,
    question: "Orang sekeliling describe anda dalam Mall sebagai?",
    options: [
  ...
  {
    id: 9,
    question: "Future goals berkaitan Mall?",
    options: [
  ...
  {
    id: 10,
    question: "Overall, Mall untuk anda adalah?",
    options: [
...
export const results = {
  A: {
    ...
    title: "Mall Champion",
    emoji: "🏬",
    description: "Anda sangat cemerlang dalam Mall! Passionate, dedicated, dan inspiring. Teruskan!",
  ...
  B: {
    ...
    title: "Mall Pro",
    emoji: "⭐",
    description: "Anda balanced dan reliable dalam Mall! Good approach dengan sustainable habits.",
  ...
  C: {
    ...
    title: "Mall Casual",
    emoji: "😊",
    description: "Anda casual dengan Mall. No stress approach, enjoy when it happens!",
  ...
  D: {
    ...
    title: "Mall Newbie",
    emoji: "🌱",
    description: "Ruang untuk grow dalam Mall! Everyone starts somewhere. Take your time!",
