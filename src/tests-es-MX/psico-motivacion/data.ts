// Test de Nivel de Motivación - Test Psicológico México
export const questions = [
  {
    id: 1,
    text: '¿Cómo te describes respecto a nivel de motivación?',
    options: [
      { text: 'Nada te detiene', type: 'muy_alta' },
      { text: 'Generalmente motivado/a', type: 'alta' },
      { text: 'Altibajos en motivación', type: 'moderada' },
      { text: 'Falta de motivación constante', type: 'baja' },
    ],
  },
  {
    id: 2,
...
export const results: Record<string, {
  ...
  muy_alta: {
    type: 'muy_alta',
    title: 'Súper Motivado/a',
    emoji: '🚀🔥',
    percentage: 'Nivel saludable',
    description: 'Nada te detiene. Tu manejo de este aspecto es muy saludable.',
  ...
  alta: {
    ...
    description: 'Generalmente motivado/a. Tienes espacio para mejorar pero estás bien.',
  ...
  moderada: {
    type: 'moderada',
    title: 'Motivación Variable',
    emoji: '💛🔄',
    percentage: 'Nivel alto - Atención',
    description: 'Altibajos en motivación. Esto puede estar afectando tu calidad de vida.',
  ...
  baja: {
    ...
    description: 'Falta de motivación constante. Este nivel puede estar causando sufrimiento significativo.',
