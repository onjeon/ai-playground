// Test de Tendencia a Compararse - Test Psicológico México
export const questions = [
  {
    id: 1,
    text: '¿Cómo te describes respecto a tendencia a compararse?',
    options: [
      { text: 'Te enfocas en ti', type: 'baja' },
      { text: 'A veces te comparas', type: 'moderada' },
      { text: 'Frecuentemente te comparas', type: 'alta' },
      { text: 'Siempre te comparas con otros', type: 'constante' },
    ],
  },
  {
    id: 2,
...
export const results: Record<string, {
  ...
  baja: {
    type: 'baja',
    title: 'No Te Comparas',
    emoji: '💚🌟',
    percentage: 'Nivel saludable',
    description: 'Te enfocas en ti. Tu manejo de este aspecto es muy saludable.',
    characteristics: ['Equilibrado/a', 'Funcional', 'Saludable', 'Resiliente', 'Estable'],
    advice: 'Sigue así. Tu manejo de este aspecto de tu vida es admirable.',
  },
  moderada: {
    type: 'moderada',
    title: 'Comparación Ocasional',
    emoji: '💛🔄',
    percentage: 'Nivel moderado',
    description: 'A veces te comparas. Tienes espacio para mejorar pero estás bien.',
  ...
  alta: {
    type: 'alta',
    title: 'Comparación Frecuente',
    emoji: '🟠📊',
    percentage: 'Nivel alto - Atención',
    description: 'Frecuentemente te comparas. Esto puede estar afectando tu calidad de vida.',
  ...
  constante: {
    ...
    description: 'Siempre te comparas con otros. Este nivel puede estar causando sufrimiento significativo.',
...
export function calculateResult(answers: number[]): typeof results[keyof typeof results] {
  const scores: Record<string, number> = { baja: 0, moderada: 0, alta: 0, constante: 0 };
