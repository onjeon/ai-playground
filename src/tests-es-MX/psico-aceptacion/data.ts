// Test de Nivel de Autoaceptación - Test Psicológico México
export const questions = [
  {
    id: 1,
    text: '¿Cómo te describes respecto a nivel de autoaceptación?',
    options: [
      { text: 'Aceptación total de ti', type: 'alta' },
      { text: 'Te aceptas con algunos peros', type: 'moderada' },
      { text: 'Luchas con aceptarte', type: 'baja' },
      { text: 'Rechazo profundo de ti', type: 'muy_baja' },
    ],
  },
  {
    id: 2,
...
export const results: Record<string, {
  ...
  alta: {
    type: 'alta',
    title: 'Te Aceptas Completamente',
    emoji: '🌟💚',
    percentage: 'Nivel saludable',
    description: 'Aceptación total de ti. Tu manejo de este aspecto es muy saludable.',
    characteristics: ['Equilibrado/a', 'Funcional', 'Saludable', 'Resiliente', 'Estable'],
    advice: 'Sigue así. Tu manejo de este aspecto de tu vida es admirable.',
  },
  moderada: {
    type: 'moderada',
    title: 'Te Aceptas en General',
    emoji: '💛✨',
    percentage: 'Nivel moderado',
    description: 'Te aceptas con algunos peros. Tienes espacio para mejorar pero estás bien.',
  ...
  baja: {
    type: 'baja',
    title: 'Te Cuesta Aceptarte',
    emoji: '🟠😔',
    percentage: 'Nivel alto - Atención',
    description: 'Luchas con aceptarte. Esto puede estar afectando tu calidad de vida.',
  ...
  muy_baja: {
    ...
    description: 'Rechazo profundo de ti. Este nivel puede estar causando sufrimiento significativo.',
