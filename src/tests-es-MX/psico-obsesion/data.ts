// Test de Tendencia Obsesiva - Test Psicológico México
export const questions = [
  {
    id: 1,
    text: '¿Cómo te describes respecto a tendencia obsesiva?',
    options: [
      { text: 'Sueltas pensamientos fácilmente', type: 'baja' },
      { text: 'A veces te enganchas', type: 'moderada' },
      { text: 'Pensamientos recurrentes frecuentes', type: 'alta' },
      { text: 'Obsesiones constantes', type: 'severa' },
    ],
  },
  {
    id: 2,
...
export const results: Record<string, {
  ...
  baja: {
    ...
    description: 'Sueltas pensamientos fácilmente. Tu manejo de este aspecto es muy saludable.',
    characteristics: ['Equilibrado/a', 'Funcional', 'Saludable', 'Resiliente', 'Estable'],
    advice: 'Sigue así. Tu manejo de este aspecto de tu vida es admirable.',
  },
  moderada: {
    type: 'moderada',
    title: 'Algo Obsesivo/a',
    emoji: '💛🔄',
    percentage: 'Nivel moderado',
    description: 'A veces te enganchas. Tienes espacio para mejorar pero estás bien.',
  ...
  alta: {
    ...
    description: 'Pensamientos recurrentes frecuentes. Esto puede estar afectando tu calidad de vida.',
  ...
  severa: {
    type: 'severa',
    title: 'Muy Obsesivo/a',
    emoji: '🔴🌀',
    percentage: 'Nivel severo - Busca ayuda',
    description: 'Obsesiones constantes. Este nivel puede estar causando sufrimiento significativo.',
