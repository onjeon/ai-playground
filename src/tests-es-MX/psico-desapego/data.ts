// Test de Capacidad de Desapego - Test Psicológico México
export const questions = [
  {
    id: 1,
    text: '¿Cómo te describes respecto a capacidad de desapego?',
    options: [
      { text: 'Sueltas fácilmente', type: 'alta' },
      { text: 'A veces te cuesta soltar', type: 'moderada' },
      { text: 'Te apegas demasiado', type: 'baja' },
      { text: 'No puedes soltar nada', type: 'muy_baja' },
    ],
  },
  {
    id: 2,
...
export const results: Record<string, {
  ...
  alta: {
    ...
    description: 'Sueltas fácilmente. Tu manejo de este aspecto es muy saludable.',
    characteristics: ['Equilibrado/a', 'Funcional', 'Saludable', 'Resiliente', 'Estable'],
    advice: 'Sigue así. Tu manejo de este aspecto de tu vida es admirable.',
  },
  moderada: {
    type: 'moderada',
    title: 'Desapego Moderado',
    emoji: '⚖️💛',
    percentage: 'Nivel moderado',
    description: 'A veces te cuesta soltar. Tienes espacio para mejorar pero estás bien.',
  ...
  baja: {
    type: 'baja',
    title: 'Apego Excesivo',
    emoji: '🔗🟠',
    percentage: 'Nivel alto - Atención',
    description: 'Te apegas demasiado. Esto puede estar afectando tu calidad de vida.',
  ...
  muy_baja: {
    ...
    description: 'No puedes soltar nada. Este nivel puede estar causando sufrimiento significativo.',
