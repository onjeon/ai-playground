// Test de Nivel de Gratitud - Test Psicológico México
export const questions = [
  {
    id: 1,
    text: '¿Cómo te describes respecto a nivel de gratitud?',
    options: [
      { text: 'Agradeces todo constantemente', type: 'muy_alta' },
      { text: 'Reconoces lo bueno frecuentemente', type: 'alta' },
      { text: 'A veces olvidas agradecer', type: 'moderada' },
      { text: 'Te cuesta ver lo positivo', type: 'baja' },
    ],
  },
  {
    id: 2,
...
export const results: Record<string, {
  ...
  muy_alta: {
    type: 'muy_alta',
    title: 'Súper Agradecido/a',
    emoji: '🌟🙏',
    percentage: 'Nivel saludable',
    description: 'Agradeces todo constantemente. Tu manejo de este aspecto es muy saludable.',
  ...
  alta: {
    ...
    description: 'Reconoces lo bueno frecuentemente. Tienes espacio para mejorar pero estás bien.',
  ...
  moderada: {
    type: 'moderada',
    title: 'Gratitud Moderada',
    emoji: '💛🔄',
    percentage: 'Nivel alto - Atención',
    description: 'A veces olvidas agradecer. Esto puede estar afectando tu calidad de vida.',
  ...
  baja: {
    ...
    description: 'Te cuesta ver lo positivo. Este nivel puede estar causando sufrimiento significativo.',
