// बॉस टाइप टेस्ट - Boss Type Test
// Boss Type Test

export const questions = [
  {
    id: 1,
    question: "बॉस टाइप टेस्ट के बारे में पहला सवाल?",
    options: [
      { text: "पहला विकल्प - Friendly Boss style", type: "A" },
      { text: "दूसरा विकल्प - Strict Boss style", type: "B" },
      { text: "तीसरा विकल्प - Invisible Boss style", type: "C" },
      { text: "चौथा विकल्प - Micromanager style", type: "D" },
    ],
  },
  {
    id: 2,
...
export const results = {
  A: {
    ...
    title: "Friendly Boss",
    emoji: "👔",
    description: "आप Friendly Boss category में हैं! Systematic, planned और organized approach। हर चीज़ में quality देखते हैं और best चाहते हैं।",
  ...
  B: {
    ...
    title: "Strict Boss",
    emoji: "👔",
    description: "आप Strict Boss category में हैं! Balanced approach, न ज्यादा strict न ज्यादा loose। Middle path prefer करते हैं।",
  ...
  C: {
    type: "C",
    title: "Invisible Boss",
    emoji: "👔",
    description: "आप Invisible Boss category में हैं! Flexible और adaptable nature। Situation के हिसाब से adjust कर लेते हैं।",
  ...
  D: {
    ...
    title: "Micromanager",
    emoji: "👔",
    description: "आप Micromanager category में हैं! Relaxed और casual approach। Life को seriously नहीं लेते, बस enjoy करते हैं।",
