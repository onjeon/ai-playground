// जॉगिंग स्टाइल टेस्ट - Jogging Style Test
// Jogging Style Test

export const questions = [
  {
    id: 1,
    question: "जॉगिंग स्टाइल टेस्ट के बारे में पहला सवाल?",
    options: [
      { text: "पहला विकल्प - Morning Runner style", type: "A" },
      { text: "दूसरा विकल्प - Evening Jogger style", type: "B" },
      { text: "तीसरा विकल्प - Treadmill Only style", type: "C" },
      { text: "चौथा विकल्प - New Year Resolution style", type: "D" },
    ],
  },
  {
    id: 2,
...
export const results = {
  A: {
    ...
    emoji: "🏃",
    description: "आप Morning Runner category में हैं! Systematic, planned और organized approach। हर चीज़ में quality देखते हैं और best चाहते हैं।",
  ...
  B: {
    type: "B",
    title: "Evening Jogger",
    emoji: "🏃",
    description: "आप Evening Jogger category में हैं! Balanced approach, न ज्यादा strict न ज्यादा loose। Middle path prefer करते हैं।",
  ...
  C: {
    type: "C",
    title: "Treadmill Only",
    emoji: "🏃",
    description: "आप Treadmill Only category में हैं! Flexible और adaptable nature। Situation के हिसाब से adjust कर लेते हैं।",
  ...
  D: {
    ...
    emoji: "🏃",
    description: "आप New Year Resolution category में हैं! Relaxed और casual approach। Life को seriously नहीं लेते, बस enjoy करते हैं।",
