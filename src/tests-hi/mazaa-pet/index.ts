// पेट पैरेंट टेस्ट - Pet Parent Test
// Pet Parent Test

export const questions = [
  {
    id: 1,
    question: "पेट पैरेंट टेस्ट के बारे में पहला सवाल?",
    options: [
      { text: "पहला विकल्प - Dog Person style", type: "A" },
      { text: "दूसरा विकल्प - Cat Person style", type: "B" },
      { text: "तीसरा विकल्प - Fish Lover style", type: "C" },
      { text: "चौथा विकल्प - No Pet Please style", type: "D" },
    ],
  },
  {
    id: 2,
...
export const results = {
  A: {
    ...
    title: "Dog Person",
    emoji: "🐕",
    description: "आप Dog Person category में हैं! Systematic, planned और organized approach। हर चीज़ में quality देखते हैं और best चाहते हैं।",
  ...
  B: {
    ...
    title: "Cat Person",
    emoji: "🐕",
    description: "आप Cat Person category में हैं! Balanced approach, न ज्यादा strict न ज्यादा loose। Middle path prefer करते हैं।",
  ...
  C: {
    ...
    title: "Fish Lover",
    emoji: "🐕",
    description: "आप Fish Lover category में हैं! Flexible और adaptable nature। Situation के हिसाब से adjust कर लेते हैं।",
  ...
  D: {
    ...
    title: "No Pet Please",
    emoji: "🐕",
    description: "आप No Pet Please category में हैं! Relaxed और casual approach। Life को seriously नहीं लेते, बस enjoy करते हैं।",
