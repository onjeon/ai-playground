// सर्दी स्टाइल टेस्ट - Winter Style Test
// Winter Style Test

export const questions = [
  {
    id: 1,
    question: "सर्दी स्टाइल टेस्ट के बारे में पहला सवाल?",
    options: [
      { text: "पहला विकल्प - Blanket Lover style", type: "A" },
      { text: "दूसरा विकल्प - Razai Fan style", type: "B" },
      { text: "तीसरा विकल्प - Heater Addict style", type: "C" },
      { text: "चौथा विकल्प - Winter Warrior style", type: "D" },
    ],
  },
  {
    id: 2,
...
export const results = {
  A: {
    ...
    title: "Blanket Lover",
    emoji: "❄️",
    description: "आप Blanket Lover category में हैं! Systematic, planned और organized approach। हर चीज़ में quality देखते हैं और best चाहते हैं।",
  ...
  B: {
    ...
    title: "Razai Fan",
    emoji: "❄️",
    description: "आप Razai Fan category में हैं! Balanced approach, न ज्यादा strict न ज्यादा loose। Middle path prefer करते हैं।",
  ...
  C: {
    ...
    title: "Heater Addict",
    emoji: "❄️",
    description: "आप Heater Addict category में हैं! Flexible और adaptable nature। Situation के हिसाब से adjust कर लेते हैं।",
  ...
  D: {
    ...
    emoji: "❄️",
    description: "आप Winter Warrior category में हैं! Relaxed और casual approach। Life को seriously नहीं लेते, बस enjoy करते हैं।",
