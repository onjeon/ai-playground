// कार ड्राइवर टेस्ट - Car Driver Test
// Car Driver Test

export const questions = [
  {
    id: 1,
    question: "कार ड्राइवर टेस्ट के बारे में पहला सवाल?",
    options: [
      { text: "पहला विकल्प - Speed Demon style", type: "A" },
      { text: "दूसरा विकल्प - Safe Driver style", type: "B" },
      { text: "तीसरा विकल्प - Sunday Driver style", type: "C" },
      { text: "चौथा विकल्प - Backseat Driver style", type: "D" },
    ],
  },
  {
    id: 2,
...
export const results = {
  A: {
    ...
    title: "Speed Demon",
    emoji: "🚗",
    description: "आप Speed Demon category में हैं! Systematic, planned और organized approach। हर चीज़ में quality देखते हैं और best चाहते हैं।",
  ...
  B: {
    ...
    title: "Safe Driver",
    emoji: "🚗",
    description: "आप Safe Driver category में हैं! Balanced approach, न ज्यादा strict न ज्यादा loose। Middle path prefer करते हैं।",
  ...
  C: {
    ...
    title: "Sunday Driver",
    emoji: "🚗",
    description: "आप Sunday Driver category में हैं! Flexible और adaptable nature। Situation के हिसाब से adjust कर लेते हैं।",
  ...
  D: {
    ...
    emoji: "🚗",
    description: "आप Backseat Driver category में हैं! Relaxed और casual approach। Life को seriously नहीं लेते, बस enjoy करते हैं।",
