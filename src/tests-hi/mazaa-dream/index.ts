// सपने देखने का टेस्ट - Dream Style Test
// Dream Style Test

export const questions = [
  {
    id: 1,
    question: "सपने देखने का टेस्ट के बारे में पहला सवाल?",
    options: [
      { text: "पहला विकल्प - Vivid Dreamer style", type: "A" },
      { text: "दूसरा विकल्प - Nightmare Fan style", type: "B" },
      { text: "तीसरा विकल्प - Lucid Master style", type: "C" },
      { text: "चौथा विकल्प - No Dreams style", type: "D" },
    ],
  },
  {
    id: 2,
...
export const results = {
  A: {
    ...
    title: "Vivid Dreamer",
    emoji: "💭",
    description: "आप Vivid Dreamer category में हैं! Systematic, planned और organized approach। हर चीज़ में quality देखते हैं और best चाहते हैं।",
  ...
  B: {
    ...
    title: "Nightmare Fan",
    emoji: "💭",
    description: "आप Nightmare Fan category में हैं! Balanced approach, न ज्यादा strict न ज्यादा loose। Middle path prefer करते हैं।",
  ...
  C: {
    ...
    title: "Lucid Master",
    emoji: "💭",
    description: "आप Lucid Master category में हैं! Flexible और adaptable nature। Situation के हिसाब से adjust कर लेते हैं।",
  ...
  D: {
    ...
    title: "No Dreams",
    emoji: "💭",
    description: "आप No Dreams category में हैं! Relaxed और casual approach। Life को seriously नहीं लेते, बस enjoy करते हैं।",
