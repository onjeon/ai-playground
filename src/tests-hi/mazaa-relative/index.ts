// रिश्तेदार टाइप टेस्ट - Relative Personality Test
// Relative Personality Test

export const questions = [
  {
    id: 1,
    question: "रिश्तेदार टाइप टेस्ट के बारे में पहला सवाल?",
    options: [
      { text: "पहला विकल्प - Favorite Relative style", type: "A" },
      { text: "दूसरा विकल्प - Advice Guru style", type: "B" },
      { text: "तीसरा विकल्प - Money Uncle style", type: "C" },
      { text: "चौथा विकल्प - Drama Queen style", type: "D" },
    ],
  },
  {
    id: 2,
...
export const results = {
  A: {
    type: "A",
    title: "Favorite Relative",
    emoji: "👨‍👩‍👧‍👦",
    description: "आप Favorite Relative category में हैं! Systematic, planned और organized approach। हर चीज़ में quality देखते हैं और best चाहते हैं।",
  ...
  B: {
    ...
    title: "Advice Guru",
    emoji: "👨‍👩‍👧‍👦",
    description: "आप Advice Guru category में हैं! Balanced approach, न ज्यादा strict न ज्यादा loose। Middle path prefer करते हैं।",
  ...
  C: {
    ...
    title: "Money Uncle",
    emoji: "👨‍👩‍👧‍👦",
    description: "आप Money Uncle category में हैं! Flexible और adaptable nature। Situation के हिसाब से adjust कर लेते हैं।",
  ...
  D: {
    ...
    title: "Drama Queen",
    emoji: "👨‍👩‍👧‍👦",
    description: "आप Drama Queen category में हैं! Relaxed और casual approach। Life को seriously नहीं लेते, बस enjoy करते हैं।",
