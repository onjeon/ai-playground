// अख़बार रीडर टेस्ट - Newspaper Reader Test
// Newspaper Reader Test

export const questions = [
  {
    id: 1,
    question: "अख़बार रीडर टेस्ट के बारे में पहला सवाल?",
    options: [
      { text: "पहला विकल्प - Front Page First style", type: "A" },
      { text: "दूसरा विकल्प - Sports Page style", type: "B" },
      { text: "तीसरा विकल्प - Editorial Reader style", type: "C" },
      { text: "चौथा विकल्प - Digital Convert style", type: "D" },
    ],
  },
  {
    id: 2,
...
export const results = {
  A: {
    type: "A",
    title: "Front Page First",
    emoji: "📰",
    description: "आप Front Page First category में हैं! Systematic, planned और organized approach। हर चीज़ में quality देखते हैं और best चाहते हैं।",
  ...
  B: {
    ...
    title: "Sports Page",
    emoji: "📰",
    description: "आप Sports Page category में हैं! Balanced approach, न ज्यादा strict न ज्यादा loose। Middle path prefer करते हैं।",
  ...
  C: {
    ...
    emoji: "📰",
    description: "आप Editorial Reader category में हैं! Flexible और adaptable nature। Situation के हिसाब से adjust कर लेते हैं।",
  ...
  D: {
    type: "D",
    title: "Digital Convert",
    emoji: "📰",
    description: "आप Digital Convert category में हैं! Relaxed और casual approach। Life को seriously नहीं लेते, बस enjoy करते हैं।",
