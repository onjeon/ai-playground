// रेगिस्तान ट्रिप टेस्ट - Desert Trip Test
// Desert Trip Test

export const questions = [
  {
    id: 1,
    question: "रेगिस्तान ट्रिप टेस्ट के बारे में पहला सवाल?",
    options: [
      { text: "पहला विकल्प - Camel Rider style", type: "A" },
      { text: "दूसरा विकल्प - Dune Basher style", type: "B" },
      { text: "तीसरा विकल्प - Camp Lover style", type: "C" },
...
export const results = {
  A: {
    ...
    title: "Camel Rider",
    emoji: "🏜️",
    description: "आप Camel Rider category में हैं! Systematic, planned और organized approach। हर चीज़ में quality देखते हैं और best चाहते हैं।",
  ...
  B: {
    ...
    title: "Dune Basher",
    emoji: "🏜️",
    description: "आप Dune Basher category में हैं! Balanced approach, न ज्यादा strict न ज्यादा loose। Middle path prefer करते हैं।",
  ...
  C: {
    ...
    title: "Camp Lover",
    emoji: "🏜️",
    description: "आप Camp Lover category में हैं! Flexible और adaptable nature। Situation के हिसाब से adjust कर लेते हैं।",
