// साइकिल राइडर टेस्ट - Cycle Rider Test
// Cycle Rider Test

export const questions = [
  {
    id: 1,
    question: "साइकिल राइडर टेस्ट के बारे में पहला सवाल?",
    options: [
      { text: "पहला विकल्प - Fitness Cyclist style", type: "A" },
      { text: "दूसरा विकल्प - Childhood Memories style", type: "B" },
      { text: "तीसरा विकल्प - Eco Warrior style", type: "C" },
      { text: "चौथा विकल्प - Rental User style", type: "D" },
    ],
  },
  {
    id: 2,
...
export const results = {
  A: {
    type: "A",
    title: "Fitness Cyclist",
    emoji: "🚲",
    description: "आप Fitness Cyclist category में हैं! Systematic, planned और organized approach। हर चीज़ में quality देखते हैं और best चाहते हैं।",
  ...
  B: {
    ...
    emoji: "🚲",
    description: "आप Childhood Memories category में हैं! Balanced approach, न ज्यादा strict न ज्यादा loose। Middle path prefer करते हैं।",
  ...
  C: {
    ...
    title: "Eco Warrior",
    emoji: "🚲",
    description: "आप Eco Warrior category में हैं! Flexible और adaptable nature। Situation के हिसाब से adjust कर लेते हैं।",
  ...
  D: {
    ...
    title: "Rental User",
    emoji: "🚲",
    description: "आप Rental User category में हैं! Relaxed और casual approach। Life को seriously नहीं लेते, बस enjoy करते हैं।",
