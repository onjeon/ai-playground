// पड़ोसी टाइप टेस्ट - Neighbor Personality Test
// Neighbor Personality Test

export const questions = [
  {
    id: 1,
    question: "पड़ोसी टाइप टेस्ट के बारे में पहला सवाल?",
    options: [
      { text: "पहला विकल्प - Friendly Neighbor style", type: "A" },
      { text: "दूसरा विकल्प - Privacy Lover style", type: "B" },
      { text: "तीसरा विकल्प - Gossip Hub style", type: "C" },
      { text: "चौथा विकल्प - Invisible Neighbor style", type: "D" },
    ],
  },
  {
    id: 2,
...
export const results = {
  A: {
    ...
    emoji: "🏘️",
    description: "आप Friendly Neighbor category में हैं! Systematic, planned और organized approach। हर चीज़ में quality देखते हैं और best चाहते हैं।",
  ...
  B: {
    ...
    title: "Privacy Lover",
    emoji: "🏘️",
    description: "आप Privacy Lover category में हैं! Balanced approach, न ज्यादा strict न ज्यादा loose। Middle path prefer करते हैं।",
  ...
  C: {
    ...
    title: "Gossip Hub",
    emoji: "🏘️",
    description: "आप Gossip Hub category में हैं! Flexible और adaptable nature। Situation के हिसाब से adjust कर लेते हैं।",
  ...
  D: {
    type: "D",
    title: "Invisible Neighbor",
    emoji: "🏘️",
    description: "आप Invisible Neighbor category में हैं! Relaxed और casual approach। Life को seriously नहीं लेते, बस enjoy करते हैं।",
