// झपकी टेस्ट - Nap Style Test
// Nap Style Test

export const questions = [
  {
    id: 1,
    question: "झपकी टेस्ट के बारे में पहला सवाल?",
    options: [
      { text: "पहला विकल्प - Power Napper style", type: "A" },
      { text: "दूसरा विकल्प - Afternoon Siesta style", type: "B" },
      { text: "तीसरा विकल्प - Desk Sleeper style", type: "C" },
      { text: "चौथा विकल्प - No Nap Ever style", type: "D" },
    ],
  },
  {
    id: 2,
...
export const results = {
  A: {
    ...
    title: "Power Napper",
    emoji: "😪",
    description: "आप Power Napper category में हैं! Systematic, planned और organized approach। हर चीज़ में quality देखते हैं और best चाहते हैं।",
  ...
  B: {
    ...
    emoji: "😪",
    description: "आप Afternoon Siesta category में हैं! Balanced approach, न ज्यादा strict न ज्यादा loose। Middle path prefer करते हैं।",
  ...
  C: {
    ...
    title: "Desk Sleeper",
    emoji: "😪",
    description: "आप Desk Sleeper category में हैं! Flexible और adaptable nature। Situation के हिसाब से adjust कर लेते हैं।",
  ...
  D: {
    ...
    title: "No Nap Ever",
    emoji: "😪",
    description: "आप No Nap Ever category में हैं! Relaxed और casual approach। Life को seriously नहीं लेते, बस enjoy करते हैं।",
