// नदी किनारे टेस्ट - Riverside Test
// Riverside Test

export const questions = [
  {
    id: 1,
    question: "नदी किनारे टेस्ट के बारे में पहला सवाल?",
    options: [
      { text: "पहला विकल्प - Ganga Lover style", type: "A" },
      { text: "दूसरा विकल्प - Boating Fan style", type: "B" },
      { text: "तीसरा विकल्प - Spiritual Soul style", type: "C" },
      { text: "चौथा विकल्प - Picnic Planner style", type: "D" },
    ],
  },
  {
    id: 2,
...
export const results = {
  A: {
    ...
    title: "Ganga Lover",
    emoji: "🏞️",
    description: "आप Ganga Lover category में हैं! Systematic, planned और organized approach। हर चीज़ में quality देखते हैं और best चाहते हैं।",
  ...
  B: {
    ...
    title: "Boating Fan",
    emoji: "🏞️",
    description: "आप Boating Fan category में हैं! Balanced approach, न ज्यादा strict न ज्यादा loose। Middle path prefer करते हैं।",
  ...
  C: {
    ...
    emoji: "🏞️",
    description: "आप Spiritual Soul category में हैं! Flexible और adaptable nature। Situation के हिसाब से adjust कर लेते हैं।",
  ...
  D: {
    ...
    emoji: "🏞️",
    description: "आप Picnic Planner category में हैं! Relaxed और casual approach। Life को seriously नहीं लेते, बस enjoy करते हैं।",
