// मोल-भाव टेस्ट - Bargaining Test
// Bargaining Test

export const questions = [
  {
    id: 1,
    question: "मोल-भाव टेस्ट के बारे में पहला सवाल?",
    options: [
      { text: "पहला विकल्प - Bargain King style", type: "A" },
      { text: "दूसरा विकल्प - Fixed Price style", type: "B" },
      { text: "तीसरा विकल्प - MRP Only style", type: "C" },
      { text: "चौथा विकल्प - Overpay Always style", type: "D" },
    ],
  },
  {
    id: 2,
...
export const results = {
  A: {
    ...
    title: "Bargain King",
    emoji: "💰",
    description: "आप Bargain King category में हैं! Systematic, planned और organized approach। हर चीज़ में quality देखते हैं और best चाहते हैं।",
  ...
  B: {
    ...
    title: "Fixed Price",
    emoji: "💰",
    description: "आप Fixed Price category में हैं! Balanced approach, न ज्यादा strict न ज्यादा loose। Middle path prefer करते हैं।",
  ...
  C: {
    ...
    title: "MRP Only",
    emoji: "💰",
    description: "आप MRP Only category में हैं! Flexible और adaptable nature। Situation के हिसाब से adjust कर लेते हैं।",
  ...
  D: {
    type: "D",
    title: "Overpay Always",
    emoji: "💰",
    description: "आप Overpay Always category में हैं! Relaxed और casual approach। Life को seriously नहीं लेते, बस enjoy करते हैं।",
