// बच्चा टाइप टेस्ट - Child Type Test
// Child Type Test

export const questions = [
  {
    id: 1,
    question: "बच्चा टाइप टेस्ट के बारे में पहला सवाल?",
    options: [
      { text: "पहला विकल्प - Genius Baby style", type: "A" },
      { text: "दूसरा विकल्प - Naughty Kid style", type: "B" },
      { text: "तीसरा विकल्प - Obedient Child style", type: "C" },
      { text: "चौथा विकल्प - Drama Kid style", type: "D" },
    ],
  },
  {
    id: 2,
...
export const results = {
  A: {
    ...
    title: "Genius Baby",
    emoji: "👶",
    description: "आप Genius Baby category में हैं! Systematic, planned और organized approach। हर चीज़ में quality देखते हैं और best चाहते हैं।",
  ...
  B: {
    ...
    title: "Naughty Kid",
    emoji: "👶",
    description: "आप Naughty Kid category में हैं! Balanced approach, न ज्यादा strict न ज्यादा loose। Middle path prefer करते हैं।",
  ...
  C: {
    type: "C",
    title: "Obedient Child",
    emoji: "👶",
    description: "आप Obedient Child category में हैं! Flexible और adaptable nature। Situation के हिसाब से adjust कर लेते हैं।",
  ...
  D: {
    ...
    title: "Drama Kid",
    emoji: "👶",
    description: "आप Drama Kid category में हैं! Relaxed और casual approach। Life को seriously नहीं लेते, बस enjoy करते हैं।",
