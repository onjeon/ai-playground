// किताब पढ़ने का टेस्ट - Book Reader Test
// Book Reader Test

export const questions = [
  {
    id: 1,
    question: "किताब पढ़ने का टेस्ट के बारे में पहला सवाल?",
    options: [
      { text: "पहला विकल्प - Bookworm style", type: "A" },
      { text: "दूसरा विकल्प - Occasional Reader style", type: "B" },
      { text: "तीसरा विकल्प - Audiobook Fan style", type: "C" },
      { text: "चौथा विकल्प - Buy but Dont Read style", type: "D" },
    ],
  },
  {
    id: 2,
...
export const results = {
  A: {
    ...
    title: "Bookworm",
    emoji: "📖",
    description: "आप Bookworm category में हैं! Systematic, planned और organized approach। हर चीज़ में quality देखते हैं और best चाहते हैं।",
  ...
  B: {
    type: "B",
    title: "Occasional Reader",
    emoji: "📖",
    description: "आप Occasional Reader category में हैं! Balanced approach, न ज्यादा strict न ज्यादा loose। Middle path prefer करते हैं।",
  ...
  C: {
    ...
    title: "Audiobook Fan",
    emoji: "📖",
    description: "आप Audiobook Fan category में हैं! Flexible और adaptable nature। Situation के हिसाब से adjust कर लेते हैं।",
  ...
  D: {
    type: "D",
    title: "Buy but Dont Read",
    emoji: "📖",
    description: "आप Buy but Dont Read category में हैं! Relaxed और casual approach। Life को seriously नहीं लेते, बस enjoy करते हैं।",
