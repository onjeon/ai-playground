// नाई टाइप टेस्ट - Barber Experience Test
// Barber Experience Test

export const questions = [
  {
    id: 1,
    question: "नाई टाइप टेस्ट के बारे में पहला सवाल?",
    options: [
      { text: "पहला विकल्प - Classic Nai style", type: "A" },
      { text: "दूसरा विकल्प - Modern Salon style", type: "B" },
      { text: "तीसरा विकल्प - Express Cut style", type: "C" },
      { text: "चौथा विकल्प - Home Barber style", type: "D" },
    ],
  },
  {
    id: 2,
...
export const results = {
  A: {
    ...
    title: "Classic Nai",
    emoji: "💈",
    description: "आप Classic Nai category में हैं! Systematic, planned और organized approach। हर चीज़ में quality देखते हैं और best चाहते हैं।",
  ...
  B: {
    ...
    title: "Modern Salon",
    emoji: "💈",
    description: "आप Modern Salon category में हैं! Balanced approach, न ज्यादा strict न ज्यादा loose। Middle path prefer करते हैं।",
  ...
  C: {
    ...
    title: "Express Cut",
    emoji: "💈",
    description: "आप Express Cut category में हैं! Flexible और adaptable nature। Situation के हिसाब से adjust कर लेते हैं।",
  ...
  D: {
    ...
    title: "Home Barber",
    emoji: "💈",
    description: "आप Home Barber category में हैं! Relaxed और casual approach। Life को seriously नहीं लेते, बस enjoy करते हैं।",
