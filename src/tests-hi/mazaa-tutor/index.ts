// ट्यूटर टाइप टेस्ट - Tutor Type Test
// Tutor Type Test

export const questions = [
  {
    id: 1,
    question: "ट्यूटर टाइप टेस्ट के बारे में पहला सवाल?",
    options: [
      { text: "पहला विकल्प - Strict Sir style", type: "A" },
      { text: "दूसरा विकल्प - Friend Teacher style", type: "B" },
      { text: "तीसरा विकल्प - Online Guru style", type: "C" },
      { text: "चौथा विकल्प - Notes Expert style", type: "D" },
    ],
  },
  {
    id: 2,
...
export const results = {
  A: {
    ...
    title: "Strict Sir",
    emoji: "👨‍🏫",
    description: "आप Strict Sir category में हैं! Systematic, planned और organized approach। हर चीज़ में quality देखते हैं और best चाहते हैं।",
  ...
  B: {
    type: "B",
    title: "Friend Teacher",
    emoji: "👨‍🏫",
    description: "आप Friend Teacher category में हैं! Balanced approach, न ज्यादा strict न ज्यादा loose। Middle path prefer करते हैं।",
  ...
  C: {
    ...
    title: "Online Guru",
    emoji: "👨‍🏫",
    description: "आप Online Guru category में हैं! Flexible और adaptable nature। Situation के हिसाब से adjust कर लेते हैं।",
  ...
  D: {
    ...
    title: "Notes Expert",
    emoji: "👨‍🏫",
    description: "आप Notes Expert category में हैं! Relaxed और casual approach। Life को seriously नहीं लेते, बस enjoy करते हैं।",
