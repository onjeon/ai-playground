// रोटी टाइप टेस्ट - Roti Type Test
// Roti Type Test

export const questions = [
  {
    id: 1,
    question: "रोटी टाइप टेस्ट के बारे में पहला सवाल?",
    options: [
      { text: "पहला विकल्प - Perfect Round style", type: "A" },
      { text: "दूसरा विकल्प - Map of India style", type: "B" },
      { text: "तीसरा विकल्प - Thick and Fluffy style", type: "C" },
      { text: "चौथा विकल्प - Ready Made style", type: "D" },
    ],
  },
  {
    id: 2,
...
export const results = {
  A: {
    ...
    title: "Perfect Round",
    emoji: "🫓",
    description: "आप Perfect Round category में हैं! Systematic, planned और organized approach। हर चीज़ में quality देखते हैं और best चाहते हैं।",
  ...
  B: {
    ...
    title: "Map of India",
    emoji: "🫓",
    description: "आप Map of India category में हैं! Balanced approach, न ज्यादा strict न ज्यादा loose। Middle path prefer करते हैं।",
  ...
  C: {
    ...
    emoji: "🫓",
    description: "आप Thick and Fluffy category में हैं! Flexible और adaptable nature। Situation के हिसाब से adjust कर लेते हैं।",
  ...
  D: {
    ...
    title: "Ready Made",
    emoji: "🫓",
    description: "आप Ready Made category में हैं! Relaxed और casual approach। Life को seriously नहीं लेते, बस enjoy करते हैं।",
