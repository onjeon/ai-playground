// गर्मी सर्वाइवल टेस्ट - Summer Survival Test
// Summer Survival Test

export const questions = [
  {
    id: 1,
    question: "गर्मी सर्वाइवल टेस्ट के बारे में पहला सवाल?",
    options: [
      { text: "पहला विकल्प - AC Lover style", type: "A" },
      { text: "दूसरा विकल्प - Kulfi Person style", type: "B" },
      { text: "तीसरा विकल्प - Hill Station Fan style", type: "C" },
      { text: "चौथा विकल्प - Survivor style", type: "D" },
    ],
  },
  {
    id: 2,
...
export const results = {
  A: {
    ...
    title: "AC Lover",
    emoji: "☀️",
    description: "आप AC Lover category में हैं! Systematic, planned और organized approach। हर चीज़ में quality देखते हैं और best चाहते हैं।",
  ...
  B: {
    ...
    title: "Kulfi Person",
    emoji: "☀️",
    description: "आप Kulfi Person category में हैं! Balanced approach, न ज्यादा strict न ज्यादा loose। Middle path prefer करते हैं।",
  ...
  C: {
    type: "C",
    title: "Hill Station Fan",
    emoji: "☀️",
    description: "आप Hill Station Fan category में हैं! Flexible और adaptable nature। Situation के हिसाब से adjust कर लेते हैं।",
  ...
  D: {
    ...
    title: "Survivor",
    emoji: "☀️",
    description: "आप Survivor category में हैं! Relaxed और casual approach। Life को seriously नहीं लेते, बस enjoy करते हैं।",
