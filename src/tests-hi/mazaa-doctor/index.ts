// डॉक्टर विज़िट टेस्ट - Doctor Visit Style Test
// Doctor Visit Style Test

export const questions = [
  {
    id: 1,
    question: "डॉक्टर विज़िट टेस्ट के बारे में पहला सवाल?",
    options: [
      { text: "पहला विकल्प - Regular Check style", type: "A" },
      { text: "दूसरा विकल्प - Emergency Only style", type: "B" },
      { text: "तीसरा विकल्प - Dr. Google style", type: "C" },
      { text: "चौथा विकल्प - Dadi ke Nuskhe style", type: "D" },
    ],
  },
  {
    id: 2,
...
export const results = {
  A: {
    ...
    title: "Regular Check",
    emoji: "🏥",
    description: "आप Regular Check category में हैं! Systematic, planned और organized approach। हर चीज़ में quality देखते हैं और best चाहते हैं।",
  ...
  B: {
    ...
    emoji: "🏥",
    description: "आप Emergency Only category में हैं! Balanced approach, न ज्यादा strict न ज्यादा loose। Middle path prefer करते हैं।",
  ...
  C: {
    ...
    title: "Dr. Google",
    emoji: "🏥",
    description: "आप Dr. Google category में हैं! Flexible और adaptable nature। Situation के हिसाब से adjust कर लेते हैं।",
  ...
  D: {
    type: "D",
    title: "Dadi ke Nuskhe",
    emoji: "🏥",
    description: "आप Dadi ke Nuskhe category में हैं! Relaxed और casual approach। Life को seriously नहीं लेते, बस enjoy करते हैं।",
