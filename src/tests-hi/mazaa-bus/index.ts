// बस यात्री टेस्ट - Bus Traveler Test
// Bus Traveler Test

export const questions = [
  {
    id: 1,
    question: "बस यात्री टेस्ट के बारे में पहला सवाल?",
    options: [
      { text: "पहला विकल्प - Window Seat style", type: "A" },
      { text: "दूसरा विकल्प - Aisle Person style", type: "B" },
      { text: "तीसरा विकल्प - Back Bencher style", type: "C" },
      { text: "चौथा विकल्प - Driver Side style", type: "D" },
    ],
  },
  {
    id: 2,
...
export const results = {
  A: {
    ...
    title: "Window Seat",
    emoji: "🚌",
    description: "आप Window Seat category में हैं! Systematic, planned और organized approach। हर चीज़ में quality देखते हैं और best चाहते हैं।",
  ...
  B: {
    ...
    title: "Aisle Person",
    emoji: "🚌",
    description: "आप Aisle Person category में हैं! Balanced approach, न ज्यादा strict न ज्यादा loose। Middle path prefer करते हैं।",
  ...
  C: {
    ...
    title: "Back Bencher",
    emoji: "🚌",
    description: "आप Back Bencher category में हैं! Flexible और adaptable nature। Situation के हिसाब से adjust कर लेते हैं।",
  ...
  D: {
    ...
    title: "Driver Side",
    emoji: "🚌",
    description: "आप Driver Side category में हैं! Relaxed और casual approach। Life को seriously नहीं लेते, बस enjoy करते हैं।",
