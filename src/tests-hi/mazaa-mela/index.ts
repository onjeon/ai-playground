// मेला एक्सपीरियंस टेस्ट - Fair Experience Test
// Fair Experience Test

export const questions = [
  {
    id: 1,
    question: "मेला एक्सपीरियंस टेस्ट के बारे में पहला सवाल?",
    options: [
      { text: "पहला विकल्प - Ride Lover style", type: "A" },
      { text: "दूसरा विकल्प - Food Explorer style", type: "B" },
      { text: "तीसरा विकल्प - Shopping Spree style", type: "C" },
      { text: "चौथा विकल्प - Crowd Avoider style", type: "D" },
    ],
  },
  {
    id: 2,
...
export const results = {
  A: {
    ...
    title: "Ride Lover",
    emoji: "🎪",
    description: "आप Ride Lover category में हैं! Systematic, planned और organized approach। हर चीज़ में quality देखते हैं और best चाहते हैं।",
  ...
  B: {
    ...
    title: "Food Explorer",
    emoji: "🎪",
    description: "आप Food Explorer category में हैं! Balanced approach, न ज्यादा strict न ज्यादा loose। Middle path prefer करते हैं।",
  ...
  C: {
    ...
    emoji: "🎪",
    description: "आप Shopping Spree category में हैं! Flexible और adaptable nature। Situation के हिसाब से adjust कर लेते हैं।",
  ...
  D: {
    ...
    title: "Crowd Avoider",
    emoji: "🎪",
    description: "आप Crowd Avoider category में हैं! Relaxed और casual approach। Life को seriously नहीं लेते, बस enjoy करते हैं।",
