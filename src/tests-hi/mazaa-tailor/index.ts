// दर्जी विज़िट टेस्ट - Tailor Visit Test
// Tailor Visit Test

export const questions = [
  {
    id: 1,
    question: "दर्जी विज़िट टेस्ट के बारे में पहला सवाल?",
    options: [
      { text: "पहला विकल्प - Design Expert style", type: "A" },
      { text: "दूसरा विकल्प - Trust Blindly style", type: "B" },
      { text: "तीसरा विकल्प - Measurement Freak style", type: "C" },
      { text: "चौथा विकल्प - Last Minute Rush style", type: "D" },
    ],
  },
  {
    id: 2,
...
export const results = {
  A: {
    ...
    title: "Design Expert",
    emoji: "🧵",
    description: "आप Design Expert category में हैं! Systematic, planned और organized approach। हर चीज़ में quality देखते हैं और best चाहते हैं।",
  ...
  B: {
    ...
    title: "Trust Blindly",
    emoji: "🧵",
    description: "आप Trust Blindly category में हैं! Balanced approach, न ज्यादा strict न ज्यादा loose। Middle path prefer करते हैं।",
  ...
  C: {
    type: "C",
    title: "Measurement Freak",
    emoji: "🧵",
    description: "आप Measurement Freak category में हैं! Flexible और adaptable nature। Situation के हिसाब से adjust कर लेते हैं।",
  ...
  D: {
    ...
    emoji: "🧵",
    description: "आप Last Minute Rush category में हैं! Relaxed और casual approach। Life को seriously नहीं लेते, बस enjoy करते हैं।",
