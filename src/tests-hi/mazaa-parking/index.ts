// पार्किंग स्टाइल टेस्ट - Parking Style Test
// Parking Style Test

export const questions = [
  {
    id: 1,
    question: "पार्किंग स्टाइल टेस्ट के बारे में पहला सवाल?",
    options: [
      { text: "पहला विकल्प - Perfect Parker style", type: "A" },
      { text: "दूसरा विकल्प - Any Spot style", type: "B" },
      { text: "तीसरा विकल्प - Valet Fan style", type: "C" },
      { text: "चौथा विकल्प - Double Park King style", type: "D" },
    ],
  },
  {
    id: 2,
...
export const results = {
  A: {
    ...
    emoji: "🅿️",
    description: "आप Perfect Parker category में हैं! Systematic, planned और organized approach। हर चीज़ में quality देखते हैं और best चाहते हैं।",
  ...
  B: {
    ...
    title: "Any Spot",
    emoji: "🅿️",
    description: "आप Any Spot category में हैं! Balanced approach, न ज्यादा strict न ज्यादा loose। Middle path prefer करते हैं।",
  ...
  C: {
    ...
    title: "Valet Fan",
    emoji: "🅿️",
    description: "आप Valet Fan category में हैं! Flexible और adaptable nature। Situation के हिसाब से adjust कर लेते हैं।",
  ...
  D: {
    type: "D",
    title: "Double Park King",
    emoji: "🅿️",
    description: "आप Double Park King category में हैं! Relaxed और casual approach। Life को seriously नहीं लेते, बस enjoy करते हैं।",
