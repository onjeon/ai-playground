// वॉक स्टाइल टेस्ट - Walking Style Test
// Walking Style Test

export const questions = [
  {
    id: 1,
    question: "वॉक स्टाइल टेस्ट के बारे में पहला सवाल?",
    options: [
      { text: "पहला विकल्प - Speed Walker style", type: "A" },
      { text: "दूसरा विकल्प - Stroller style", type: "B" },
      { text: "तीसरा विकल्प - Podcast Walker style", type: "C" },
      { text: "चौथा विकल्प - Phone Zombie style", type: "D" },
    ],
  },
  {
    id: 2,
...
export const results = {
  A: {
    ...
    title: "Speed Walker",
    emoji: "🚶",
    description: "आप Speed Walker category में हैं! Systematic, planned और organized approach। हर चीज़ में quality देखते हैं और best चाहते हैं।",
  ...
  B: {
    ...
    title: "Stroller",
    emoji: "🚶",
    description: "आप Stroller category में हैं! Balanced approach, न ज्यादा strict न ज्यादा loose। Middle path prefer करते हैं।",
  ...
  C: {
    type: "C",
    title: "Podcast Walker",
    emoji: "🚶",
    description: "आप Podcast Walker category में हैं! Flexible और adaptable nature। Situation के हिसाब से adjust कर लेते हैं।",
  ...
  D: {
    ...
    title: "Phone Zombie",
    emoji: "🚶",
    description: "आप Phone Zombie category में हैं! Relaxed और casual approach। Life को seriously नहीं लेते, बस enjoy करते हैं।",
