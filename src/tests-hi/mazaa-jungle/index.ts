// जंगल सफारी टेस्ट - Jungle Safari Test
// Jungle Safari Test

export const questions = [
  {
    id: 1,
    question: "जंगल सफारी टेस्ट के बारे में पहला सवाल?",
    options: [
      { text: "पहला विकल्प - Wildlife Expert style", type: "A" },
      { text: "दूसरा विकल्प - Photo Hunter style", type: "B" },
      { text: "तीसरा विकल्प - Scared Tourist style", type: "C" },
      { text: "चौथा विकल्प - Nature Lover style", type: "D" },
    ],
  },
  {
    id: 2,
...
export const results = {
  A: {
    ...
    emoji: "🐯",
    description: "आप Wildlife Expert category में हैं! Systematic, planned और organized approach। हर चीज़ में quality देखते हैं और best चाहते हैं।",
  ...
  B: {
    ...
    title: "Photo Hunter",
    emoji: "🐯",
    description: "आप Photo Hunter category में हैं! Balanced approach, न ज्यादा strict न ज्यादा loose। Middle path prefer करते हैं।",
  ...
  C: {
    type: "C",
    title: "Scared Tourist",
    emoji: "🐯",
    description: "आप Scared Tourist category में हैं! Flexible और adaptable nature। Situation के हिसाब से adjust कर लेते हैं।",
  ...
  D: {
    ...
    title: "Nature Lover",
    emoji: "🐯",
    description: "आप Nature Lover category में हैं! Relaxed और casual approach। Life को seriously नहीं लेते, बस enjoy करते हैं।",
