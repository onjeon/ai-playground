// एयरपोर्ट बिहेवियर टेस्ट - Airport Behavior Test
// Airport Behavior Test

export const questions = [
  {
    id: 1,
    question: "एयरपोर्ट बिहेवियर टेस्ट के बारे में पहला सवाल?",
    options: [
      { text: "पहला विकल्प - Early Bird style", type: "A" },
      { text: "दूसरा विकल्प - Last Minute style", type: "B" },
      { text: "तीसरा विकल्प - Lounge Lover style", type: "C" },
      { text: "चौथा विकल्प - Gate Runner style", type: "D" },
    ],
  },
  {
    id: 2,
...
export const results = {
  A: {
    ...
    title: "Early Bird",
    emoji: "✈️",
    description: "आप Early Bird category में हैं! Systematic, planned और organized approach। हर चीज़ में quality देखते हैं और best चाहते हैं।",
  ...
  B: {
    ...
    title: "Last Minute",
    emoji: "✈️",
    description: "आप Last Minute category में हैं! Balanced approach, न ज्यादा strict न ज्यादा loose। Middle path prefer करते हैं।",
  ...
  C: {
    ...
    title: "Lounge Lover",
    emoji: "✈️",
    description: "आप Lounge Lover category में हैं! Flexible और adaptable nature। Situation के हिसाब से adjust कर लेते हैं।",
  ...
  D: {
    ...
    title: "Gate Runner",
    emoji: "✈️",
    description: "आप Gate Runner category में हैं! Relaxed और casual approach। Life को seriously नहीं लेते, बस enjoy करते हैं।",
