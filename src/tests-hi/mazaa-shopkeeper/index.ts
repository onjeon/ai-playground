// दुकानदार टाइप टेस्ट - Shopkeeper Type Test
// Shopkeeper Type Test

export const questions = [
  {
    id: 1,
    question: "दुकानदार टाइप टेस्ट के बारे में पहला सवाल?",
    options: [
      { text: "पहला विकल्प - Best Friend Type style", type: "A" },
      { text: "दूसरा विकल्प - Professional style", type: "B" },
      { text: "तीसरा विकल्प - Bargain Enemy style", type: "C" },
      { text: "चौथा विकल्प - Credit King style", type: "D" },
    ],
  },
  {
    id: 2,
...
export const results = {
  A: {
    type: "A",
    title: "Best Friend Type",
    emoji: "🏪",
    description: "आप Best Friend Type category में हैं! Systematic, planned और organized approach। हर चीज़ में quality देखते हैं और best चाहते हैं।",
  ...
  B: {
    ...
    title: "Professional",
    emoji: "🏪",
    description: "आप Professional category में हैं! Balanced approach, न ज्यादा strict न ज्यादा loose। Middle path prefer करते हैं।",
  ...
  C: {
    ...
    title: "Bargain Enemy",
    emoji: "🏪",
    description: "आप Bargain Enemy category में हैं! Flexible और adaptable nature। Situation के हिसाब से adjust कर लेते हैं।",
  ...
  D: {
    ...
    title: "Credit King",
    emoji: "🏪",
    description: "आप Credit King category में हैं! Relaxed और casual approach। Life को seriously नहीं लेते, बस enjoy करते हैं।",
