// कलीग टाइप टेस्ट - Colleague Type Test
// Colleague Type Test

export const questions = [
  {
    id: 1,
    question: "कलीग टाइप टेस्ट के बारे में पहला सवाल?",
    options: [
      { text: "पहला विकल्प - Work BFF style", type: "A" },
      { text: "दूसरा विकल्प - Professional Only style", type: "B" },
      { text: "तीसरा विकल्प - Gossip Partner style", type: "C" },
      { text: "चौथा विकल्प - Competition style", type: "D" },
    ],
  },
  {
    id: 2,
...
export const results = {
  A: {
    ...
    title: "Work BFF",
    emoji: "🤝",
    description: "आप Work BFF category में हैं! Systematic, planned और organized approach। हर चीज़ में quality देखते हैं और best चाहते हैं।",
  ...
  B: {
    ...
    emoji: "🤝",
    description: "आप Professional Only category में हैं! Balanced approach, न ज्यादा strict न ज्यादा loose। Middle path prefer करते हैं।",
  ...
  C: {
    type: "C",
    title: "Gossip Partner",
    emoji: "🤝",
    description: "आप Gossip Partner category में हैं! Flexible और adaptable nature। Situation के हिसाब से adjust कर लेते हैं।",
  ...
  D: {
    ...
    title: "Competition",
    emoji: "🤝",
    description: "आप Competition category में हैं! Relaxed और casual approach। Life को seriously नहीं लेते, बस enjoy करते हैं।",
