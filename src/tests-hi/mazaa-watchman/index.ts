// वॉचमैन रिलेशन टेस्ट - Watchman Relation Test
// Watchman Relation Test

export const questions = [
  {
    id: 1,
    question: "वॉचमैन रिलेशन टेस्ट के बारे में पहला सवाल?",
    options: [
      { text: "पहला विकल्प - Best Buddy style", type: "A" },
      { text: "दूसरा विकल्प - Formal Only style", type: "B" },
      { text: "तीसरा विकल्प - Invisible style", type: "C" },
      { text: "चौथा विकल्प - Festival Tipper style", type: "D" },
    ],
  },
  {
    id: 2,
...
export const results = {
  A: {
    ...
    title: "Best Buddy",
    emoji: "👮",
    description: "आप Best Buddy category में हैं! Systematic, planned और organized approach। हर चीज़ में quality देखते हैं और best चाहते हैं।",
  ...
  B: {
    ...
    title: "Formal Only",
    emoji: "👮",
    description: "आप Formal Only category में हैं! Balanced approach, न ज्यादा strict न ज्यादा loose। Middle path prefer करते हैं।",
  ...
  C: {
    ...
    title: "Invisible",
    emoji: "👮",
    description: "आप Invisible category में हैं! Flexible और adaptable nature। Situation के हिसाब से adjust कर लेते हैं।",
  ...
  D: {
    type: "D",
    title: "Festival Tipper",
    emoji: "👮",
    description: "आप Festival Tipper category में हैं! Relaxed और casual approach। Life को seriously नहीं लेते, बस enjoy करते हैं।",
