// टीवी वॉचर टेस्ट - TV Watcher Test
// TV Watcher Test

export const questions = [
  {
    id: 1,
    question: "टीवी वॉचर टेस्ट के बारे में पहला सवाल?",
    options: [
      { text: "पहला विकल्प - News Addict style", type: "A" },
      { text: "दूसरा विकल्प - Serial Lover style", type: "B" },
      { text: "तीसरा विकल्प - Sports Fan style", type: "C" },
      { text: "चौथा विकल्प - Netflix Only style", type: "D" },
    ],
  },
  {
    id: 2,
...
export const results = {
  A: {
    ...
    title: "News Addict",
    emoji: "📺",
    description: "आप News Addict category में हैं! Systematic, planned और organized approach। हर चीज़ में quality देखते हैं और best चाहते हैं।",
  ...
  B: {
    ...
    title: "Serial Lover",
    emoji: "📺",
    description: "आप Serial Lover category में हैं! Balanced approach, न ज्यादा strict न ज्यादा loose। Middle path prefer करते हैं।",
  ...
  C: {
    ...
    title: "Sports Fan",
    emoji: "📺",
    description: "आप Sports Fan category में हैं! Flexible और adaptable nature। Situation के हिसाब से adjust कर लेते हैं।",
  ...
  D: {
    ...
    title: "Netflix Only",
    emoji: "📺",
    description: "आप Netflix Only category में हैं! Relaxed और casual approach। Life को seriously नहीं लेते, बस enjoy करते हैं।",
