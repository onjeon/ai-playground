// पनीर लवर टेस्ट - Paneer Lover Test
// Paneer Lover Test

export const questions = [
  {
    id: 1,
    question: "पनीर लवर टेस्ट के बारे में पहला सवाल?",
    options: [
      { text: "पहला विकल्प - Paneer Addict style", type: "A" },
      { text: "दूसरा विकल्प - Occasional Lover style", type: "B" },
      { text: "तीसरा विकल्प - Tofu Convert style", type: "C" },
      { text: "चौथा विकल्प - Paneer Hater style", type: "D" },
    ],
  },
  {
    id: 2,
...
export const results = {
  A: {
    ...
    title: "Paneer Addict",
    emoji: "🧀",
    description: "आप Paneer Addict category में हैं! Systematic, planned और organized approach। हर चीज़ में quality देखते हैं और best चाहते हैं।",
  ...
  B: {
    type: "B",
    title: "Occasional Lover",
    emoji: "🧀",
    description: "आप Occasional Lover category में हैं! Balanced approach, न ज्यादा strict न ज्यादा loose। Middle path prefer करते हैं।",
  ...
  C: {
    ...
    title: "Tofu Convert",
    emoji: "🧀",
    description: "आप Tofu Convert category में हैं! Flexible और adaptable nature। Situation के हिसाब से adjust कर लेते हैं।",
  ...
  D: {
    ...
    title: "Paneer Hater",
    emoji: "🧀",
    description: "आप Paneer Hater category में हैं! Relaxed और casual approach। Life को seriously नहीं लेते, बस enjoy करते हैं।",
