// डेटिंग ऐप टेस्ट - Dating App Test
// Dating App Test

export const questions = [
  {
    id: 1,
    question: "डेटिंग ऐप टेस्ट के बारे में पहला सवाल?",
    options: [
      { text: "पहला विकल्प - Swipe Right King style", type: "A" },
      { text: "दूसरा विकल्प - Bio Expert style", type: "B" },
      { text: "तीसरा विकल्प - Ghost Master style", type: "C" },
      { text: "चौथा विकल्प - Delete and Install style", type: "D" },
    ],
  },
  {
    id: 2,
...
export const results = {
  A: {
    type: "A",
    title: "Swipe Right King",
    emoji: "💘",
    description: "आप Swipe Right King category में हैं! Systematic, planned और organized approach। हर चीज़ में quality देखते हैं और best चाहते हैं।",
  ...
  B: {
    ...
    title: "Bio Expert",
    emoji: "💘",
    description: "आप Bio Expert category में हैं! Balanced approach, न ज्यादा strict न ज्यादा loose। Middle path prefer करते हैं।",
  ...
  C: {
    ...
    title: "Ghost Master",
    emoji: "💘",
    description: "आप Ghost Master category में हैं! Flexible और adaptable nature। Situation के हिसाब से adjust कर लेते हैं।",
  ...
  D: {
    type: "D",
    title: "Delete and Install",
    emoji: "💘",
    description: "आप Delete and Install category में हैं! Relaxed और casual approach। Life को seriously नहीं लेते, बस enjoy करते हैं।",
