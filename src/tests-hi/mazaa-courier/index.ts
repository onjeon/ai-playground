// कोरियर वेटिंग टेस्ट - Courier Waiting Test
// Courier Waiting Test

export const questions = [
  {
    id: 1,
    question: "कोरियर वेटिंग टेस्ट के बारे में पहला सवाल?",
    options: [
      { text: "पहला विकल्प - Track Obsessed style", type: "A" },
      { text: "दूसरा विकल्प - Patient Waiter style", type: "B" },
      { text: "तीसरा विकल्प - Call Bomber style", type: "C" },
      { text: "चौथा विकल्प - Forgot About It style", type: "D" },
    ],
  },
  {
    id: 2,
...
export const results = {
  A: {
    type: "A",
    title: "Track Obsessed",
    emoji: "📦",
    description: "आप Track Obsessed category में हैं! Systematic, planned और organized approach। हर चीज़ में quality देखते हैं और best चाहते हैं।",
  ...
  B: {
    type: "B",
    title: "Patient Waiter",
    emoji: "📦",
    description: "आप Patient Waiter category में हैं! Balanced approach, न ज्यादा strict न ज्यादा loose। Middle path prefer करते हैं।",
  ...
  C: {
    ...
    title: "Call Bomber",
    emoji: "📦",
    description: "आप Call Bomber category में हैं! Flexible और adaptable nature। Situation के हिसाब से adjust कर लेते हैं।",
  ...
  D: {
    ...
    emoji: "📦",
    description: "आप Forgot About It category में हैं! Relaxed और casual approach। Life को seriously नहीं लेते, बस enjoy करते हैं।",
