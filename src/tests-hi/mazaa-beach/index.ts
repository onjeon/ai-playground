// बीच वाइब्स टेस्ट - Beach Vibes Test
// Beach Vibes Test

export const questions = [
  {
    id: 1,
    question: "बीच वाइब्स टेस्ट के बारे में पहला सवाल?",
    options: [
      { text: "पहला विकल्प - Water Baby style", type: "A" },
      { text: "दूसरा विकल्प - Sand Lover style", type: "B" },
      { text: "तीसरा विकल्प - Sunset Watcher style", type: "C" },
      { text: "चौथा विकल्प - Beach Avoider style", type: "D" },
    ],
  },
  {
    id: 2,
...
export const results = {
  A: {
    ...
    title: "Water Baby",
    emoji: "🏖️",
    description: "आप Water Baby category में हैं! Systematic, planned और organized approach। हर चीज़ में quality देखते हैं और best चाहते हैं।",
  ...
  B: {
    ...
    title: "Sand Lover",
    emoji: "🏖️",
    description: "आप Sand Lover category में हैं! Balanced approach, न ज्यादा strict न ज्यादा loose। Middle path prefer करते हैं।",
  ...
  C: {
    type: "C",
    title: "Sunset Watcher",
    emoji: "🏖️",
    description: "आप Sunset Watcher category में हैं! Flexible और adaptable nature। Situation के हिसाब से adjust कर लेते हैं।",
  ...
  D: {
    ...
    title: "Beach Avoider",
    emoji: "🏖️",
    description: "आप Beach Avoider category में हैं! Relaxed और casual approach। Life को seriously नहीं लेते, बस enjoy करते हैं।",
