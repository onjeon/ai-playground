// म्यूज़ियम विज़िट टेस्ट - Museum Visit Test
// Museum Visit Test

export const questions = [
  {
    id: 1,
    question: "म्यूज़ियम विज़िट टेस्ट के बारे में पहला सवाल?",
    options: [
      { text: "पहला विकल्प - History Buff style", type: "A" },
      { text: "दूसरा विकल्प - Art Lover style", type: "B" },
      { text: "तीसरा विकल्प - Quick Walker style", type: "C" },
      { text: "चौथा विकल्प - AC Seeker style", type: "D" },
    ],
  },
  {
    id: 2,
...
export const results = {
  A: {
    ...
    title: "History Buff",
    emoji: "🏛️",
    description: "आप History Buff category में हैं! Systematic, planned और organized approach। हर चीज़ में quality देखते हैं और best चाहते हैं।",
  ...
  B: {
    ...
    title: "Art Lover",
    emoji: "🏛️",
    description: "आप Art Lover category में हैं! Balanced approach, न ज्यादा strict न ज्यादा loose। Middle path prefer करते हैं।",
  ...
  C: {
    ...
    title: "Quick Walker",
    emoji: "🏛️",
    description: "आप Quick Walker category में हैं! Flexible और adaptable nature। Situation के हिसाब से adjust कर लेते हैं।",
  ...
  D: {
    ...
    title: "AC Seeker",
    emoji: "🏛️",
    description: "आप AC Seeker category में हैं! Relaxed और casual approach। Life को seriously नहीं लेते, बस enjoy करते हैं।",
