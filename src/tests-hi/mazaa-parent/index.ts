// पैरेंट टाइप टेस्ट - Parent Type Test
// Parent Type Test

export const questions = [
  {
    id: 1,
    question: "पैरेंट टाइप टेस्ट के बारे में पहला सवाल?",
    options: [
      { text: "पहला विकल्प - Strict Parent style", type: "A" },
      { text: "दूसरा विकल्प - Cool Parent style", type: "B" },
      { text: "तीसरा विकल्प - Helicopter style", type: "C" },
      { text: "चौथा विकल्प - Friend Parent style", type: "D" },
    ],
  },
  {
    id: 2,
...
export const results = {
  A: {
    ...
    title: "Strict Parent",
    emoji: "👪",
    description: "आप Strict Parent category में हैं! Systematic, planned और organized approach। हर चीज़ में quality देखते हैं और best चाहते हैं।",
  ...
  B: {
    ...
    title: "Cool Parent",
    emoji: "👪",
    description: "आप Cool Parent category में हैं! Balanced approach, न ज्यादा strict न ज्यादा loose। Middle path prefer करते हैं।",
  ...
  C: {
    ...
    title: "Helicopter",
    emoji: "👪",
    description: "आप Helicopter category में हैं! Flexible और adaptable nature। Situation के हिसाब से adjust कर लेते हैं।",
  ...
  D: {
    ...
    title: "Friend Parent",
    emoji: "👪",
    description: "आप Friend Parent category में हैं! Relaxed और casual approach। Life को seriously नहीं लेते, बस enjoy करते हैं।",
