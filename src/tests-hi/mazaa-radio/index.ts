// रेडियो लिसनर टेस्ट - Radio Listener Test
// Radio Listener Test

export const questions = [
  {
    id: 1,
    question: "रेडियो लिसनर टेस्ट के बारे में पहला सवाल?",
    options: [
      { text: "पहला विकल्प - Morning Walker style", type: "A" },
      { text: "दूसरा विकल्प - Traffic Time style", type: "B" },
      { text: "तीसरा विकल्प - Nostalgia Fan style", type: "C" },
      { text: "चौथा विकल्प - Podcast Convert style", type: "D" },
    ],
  },
  {
    id: 2,
...
export const results = {
  A: {
    ...
    emoji: "📻",
    description: "आप Morning Walker category में हैं! Systematic, planned और organized approach। हर चीज़ में quality देखते हैं और best चाहते हैं।",
  ...
  B: {
    ...
    title: "Traffic Time",
    emoji: "📻",
    description: "आप Traffic Time category में हैं! Balanced approach, न ज्यादा strict न ज्यादा loose। Middle path prefer करते हैं।",
  ...
  C: {
    ...
    title: "Nostalgia Fan",
    emoji: "📻",
    description: "आप Nostalgia Fan category में हैं! Flexible और adaptable nature। Situation के हिसाब से adjust कर लेते हैं।",
  ...
  D: {
    type: "D",
    title: "Podcast Convert",
    emoji: "📻",
    description: "आप Podcast Convert category में हैं! Relaxed और casual approach। Life को seriously नहीं लेते, बस enjoy करते हैं।",
