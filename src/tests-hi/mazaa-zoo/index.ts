// चिड़ियाघर विज़िट टेस्ट - Zoo Visit Test
// Zoo Visit Test

export const questions = [
  {
    id: 1,
    question: "चिड़ियाघर विज़िट टेस्ट के बारे में पहला सवाल?",
    options: [
      { text: "पहला विकल्प - Animal Lover style", type: "A" },
      { text: "दूसरा विकल्प - Photo Clicker style", type: "B" },
      { text: "तीसरा विकल्प - Kid Entertainer style", type: "C" },
      { text: "चौथा विकल्प - Bored Visitor style", type: "D" },
    ],
  },
  {
    id: 2,
...
export const results = {
  A: {
    ...
    title: "Animal Lover",
    emoji: "🦁",
    description: "आप Animal Lover category में हैं! Systematic, planned और organized approach। हर चीज़ में quality देखते हैं और best चाहते हैं।",
  ...
  B: {
    ...
    title: "Photo Clicker",
    emoji: "🦁",
    description: "आप Photo Clicker category में हैं! Balanced approach, न ज्यादा strict न ज्यादा loose। Middle path prefer करते हैं।",
  ...
  C: {
    type: "C",
    title: "Kid Entertainer",
    emoji: "🦁",
    description: "आप Kid Entertainer category में हैं! Flexible और adaptable nature। Situation के हिसाब से adjust कर लेते हैं।",
  ...
  D: {
    ...
    title: "Bored Visitor",
    emoji: "🦁",
    description: "आप Bored Visitor category में हैं! Relaxed और casual approach। Life को seriously नहीं लेते, बस enjoy करते हैं।",
