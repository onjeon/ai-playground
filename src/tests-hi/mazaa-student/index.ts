// स्टूडेंट टाइप टेस्ट - Student Type Test
// Student Type Test

export const questions = [
  {
    id: 1,
    question: "स्टूडेंट टाइप टेस्ट के बारे में पहला सवाल?",
    options: [
      { text: "पहला विकल्प - Topper style", type: "A" },
      { text: "दूसरा विकल्प - Last Bencher style", type: "B" },
      { text: "तीसरा विकल्प - Proxy Expert style", type: "C" },
      { text: "चौथा विकल्प - All-rounder style", type: "D" },
    ],
  },
  {
    id: 2,
...
export const results = {
  A: {
    ...
    title: "Topper",
    emoji: "📚",
    description: "आप Topper category में हैं! Systematic, planned और organized approach। हर चीज़ में quality देखते हैं और best चाहते हैं।",
  ...
  B: {
    ...
    title: "Last Bencher",
    emoji: "📚",
    description: "आप Last Bencher category में हैं! Balanced approach, न ज्यादा strict न ज्यादा loose। Middle path prefer करते हैं।",
  ...
  C: {
    ...
    title: "Proxy Expert",
    emoji: "📚",
    description: "आप Proxy Expert category में हैं! Flexible और adaptable nature। Situation के हिसाब से adjust कर लेते हैं।",
  ...
  D: {
    ...
    title: "All-rounder",
    emoji: "📚",
    description: "आप All-rounder category में हैं! Relaxed और casual approach। Life को seriously नहीं लेते, बस enjoy करते हैं।",
