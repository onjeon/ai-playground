// लैपटॉप यूज़र टेस्ट - Laptop User Test
// Laptop User Test

export const questions = [
  {
    id: 1,
    question: "लैपटॉप यूज़र टेस्ट के बारे में पहला सवाल?",
    options: [
      { text: "पहला विकल्प - Work Machine style", type: "A" },
      { text: "दूसरा विकल्प - Entertainment style", type: "B" },
      { text: "तीसरा विकल्प - Minimal Use style", type: "C" },
      { text: "चौथा विकल्प - Gaming Beast style", type: "D" },
    ],
  },
  {
    id: 2,
...
export const results = {
  A: {
    ...
    title: "Work Machine",
    emoji: "💻",
    description: "आप Work Machine category में हैं! Systematic, planned और organized approach। हर चीज़ में quality देखते हैं और best चाहते हैं।",
  ...
  B: {
    ...
    title: "Entertainment",
    emoji: "💻",
    description: "आप Entertainment category में हैं! Balanced approach, न ज्यादा strict न ज्यादा loose। Middle path prefer करते हैं।",
  ...
  C: {
    ...
    title: "Minimal Use",
    emoji: "💻",
    description: "आप Minimal Use category में हैं! Flexible और adaptable nature। Situation के हिसाब से adjust कर लेते हैं।",
  ...
  D: {
    ...
    title: "Gaming Beast",
    emoji: "💻",
    description: "आप Gaming Beast category में हैं! Relaxed और casual approach। Life को seriously नहीं लेते, बस enjoy करते हैं।",
