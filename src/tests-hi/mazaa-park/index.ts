// पार्क विज़िट टेस्ट - Park Visit Test
// Park Visit Test

export const questions = [
  {
    id: 1,
    question: "पार्क विज़िट टेस्ट के बारे में पहला सवाल?",
    options: [
      { text: "पहला विकल्प - Morning Walker style", type: "A" },
      { text: "दूसरा विकल्प - Evening Chiller style", type: "B" },
      { text: "तीसरा विकल्प - Picnic Planner style", type: "C" },
      { text: "चौथा विकल्प - Bench Sitter style", type: "D" },
    ],
  },
  {
    id: 2,
...
export const results = {
  ...
  B: {
    type: "B",
    title: "Evening Chiller",
    emoji: "🌳",
    description: "आप Evening Chiller category में हैं! Balanced approach, न ज्यादा strict न ज्यादा loose। Middle path prefer करते हैं।",
  ...
  C: {
    ...
    emoji: "🌳",
    description: "आप Picnic Planner category में हैं! Flexible और adaptable nature। Situation के हिसाब से adjust कर लेते हैं।",
  ...
  D: {
    ...
    title: "Bench Sitter",
    emoji: "🌳",
    description: "आप Bench Sitter category में हैं! Relaxed और casual approach। Life को seriously नहीं लेते, बस enjoy करते हैं।",
