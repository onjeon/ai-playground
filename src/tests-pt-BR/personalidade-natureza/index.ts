// Sua personalidade na Natureza
// Descubra sua personalidade na natureza!

export const questions = [
  {
    id: 1,
    question: "Qual sua relação com a natureza?",
    options: [
      { text: "Amo trilhas e aventuras", type: "A" },
      { text: "Gosto de parques e praias", type: "B" },
      { text: "Prefiro ambientes urbanos", type: "C" },
      { text: "Natureza? Tem Wi-Fi?", type: "D" },
    ],
  },
  {
    id: 2,
