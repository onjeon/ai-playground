...
// Descubra sua personalidade na cozinha!

export const questions = [
  {
    id: 1,
    question: "Como você é na cozinha?",
    options: [
      { text: "Chef, amo cozinhar", type: "A" },
      { text: "Me viro quando preciso", type: "B" },
      { text: "Só básico, arroz e ovo", type: "C" },
      { text: "Delivery é meu amigo", type: "D" },
    ],
  },
  {
    id: 2,
