// Sua personalidade na Festa
// Descubra sua personalidade na festa!

export const questions = [
  {
    id: 1,
    question: "Como você é nas festas?",
    options: [
      { text: "Primeiro a chegar, último a sair", type: "A" },
      { text: "Danço a noite toda", type: "B" },
      { text: "Fico no canto conversando", type: "C" },
      { text: "Prefiro festas pequenas", type: "D" },
    ],
  },
  {
    id: 2,
