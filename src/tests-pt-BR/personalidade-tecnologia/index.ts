// Sua personalidade com Tecnologia
// Descubra sua personalidade com tecnologia!
...
export const questions = [
  {
    ...
    options: [
      { text: "Early adopter, amo novidades", type: "A" },
      { text: "Uso o necessário", type: "B" },
      { text: "Só o básico", type: "C" },
      { text: "Prefiro o analógico", type: "D" },
    ],
  },
  {
    id: 2,
