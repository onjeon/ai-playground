...
// Descubra sua personalidade no trabalho!
...
export const questions = [
  {
    ...
    options: [
      { text: "Workaholic, amo o que faço", type: "A" },
      { text: "Equilibrado, trabalho e vida", type: "B" },
      { text: "Trabalho para viver, não vivo para trabalhar", type: "C" },
      { text: "Sonho em não precisar trabalhar", type: "D" },
    ],
  },
  {
    id: 2,
