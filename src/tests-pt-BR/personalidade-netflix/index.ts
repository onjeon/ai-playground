// Sua personalidade na Netflix
// Descubra sua personalidade na netflix!

export const questions = [
  {
    id: 1,
    question: "Como você assiste Netflix?",
    options: [
      { text: "Maratona até acabar a série", type: "A" },
      { text: "Um episódio por dia", type: "B" },
      { text: "Só nos fins de semana", type: "C" },
      { text: "Fico procurando e não assisto nada", type: "D" },
    ],
  },
  {
    id: 2,
