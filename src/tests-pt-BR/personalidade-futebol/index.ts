// Sua personalidade no Futebol
// Descubra sua personalidade no futebol!

export const questions = [
  {
    id: 1,
    question: "Como você é com futebol?",
    options: [
      { text: "Fanático, não perco um jogo!", type: "A" },
      { text: "Assisto com amigos socialmente", type: "B" },
      { text: "Só na Copa do Mundo", type: "C" },
      { text: "Não ligo para futebol", type: "D" },
    ],
  },
  {
    id: 2,
