// Sua personalidade de Manhã
// Descubra sua personalidade de manhã!
...
export const questions = [
  {
    ...
    options: [
      { text: "Produtivo desde cedo", type: "A" },
      { text: "Café e calma primeiro", type: "B" },
      { text: "Correria para não atrasar", type: "C" },
      { text: "Não funciono de manhã", type: "D" },
    ],
  },
  {
    id: 2,
