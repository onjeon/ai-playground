// Sua personalidade com Segredos
// Descubra sua personalidade com segredos!

export const questions = [
  {
    id: 1,
    question: "Como você é com segredos?",
    options: [
      { text: "Cofre, nunca conto", type: "A" },
      { text: "Guardo se for importante", type: "B" },
      { text: "Às vezes escapa", type: "C" },
      { text: "Não sei guardar", type: "D" },
    ],
  },
  {
    id: 2,
