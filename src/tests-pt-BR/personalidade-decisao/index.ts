// Sua personalidade na Decisão
// Descubra sua personalidade na decisão!
...
export const questions = [
  {
    ...
    options: [
      { text: "Rápido, confio no instinto", type: "A" },
      { text: "Analiso tudo antes", type: "B" },
      { text: "Peço opiniões", type: "C" },
      { text: "Demoro muito para decidir", type: "D" },
    ],
  },
  {
    id: 2,
