// Sua personalidade na Família
// Descubra sua personalidade na família!

export const questions = [
  {
    id: 1,
    question: "Qual seu papel na família?",
    options: [
      { text: "O líder e organizador", type: "A" },
      { text: "O pacificador", type: "B" },
      { text: "O engraçado", type: "C" },
      { text: "O quieto", type: "D" },
    ],
  },
  {
    id: 2,
