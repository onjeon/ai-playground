...
// Descubra sua personalidade criativa!

export const questions = [
  {
    id: 1,
    question: "Quão criativo você é?",
    options: [
      { text: "Muito, sempre tendo ideias", type: "A" },
      { text: "Criativo quando preciso", type: "B" },
      { text: "Prefiro seguir regras", type: "C" },
      { text: "Não me considero criativo", type: "D" },
    ],
  },
  {
    id: 2,
