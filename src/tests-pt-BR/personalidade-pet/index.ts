// Sua personalidade com Pets
// Descubra sua personalidade com pets!

export const questions = [
  {
    id: 1,
    question: "Qual sua relação com animais?",
    options: [
      { text: "Tenho vários, amo demais!", type: "A" },
      { text: "Tenho um, é da família", type: "B" },
      { text: "Gosto mas não tenho", type: "C" },
      { text: "Não sou muito fã", type: "D" },
    ],
  },
  {
    id: 2,
