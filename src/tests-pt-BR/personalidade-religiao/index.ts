// Sua Espiritualidade
// Descubra sua espiritualidade!

export const questions = [
  {
    id: 1,
    question: "Qual sua relação com espiritualidade?",
    options: [
      { text: "Muito religioso/espiritual", type: "A" },
      { text: "Acredito mas não pratico", type: "B" },
      { text: "Agnóstico, em dúvida", type: "C" },
      { text: "Ateu ou indiferente", type: "D" },
    ],
  },
  {
    id: 2,
