// Sua personalidade na Organização
// Descubra sua personalidade na organização!

export const questions = [
  {
    id: 1,
    question: "Quão organizado você é?",
    options: [
      { text: "Tudo no lugar, sempre", type: "A" },
      { text: "Organizado no trabalho", type: "B" },
      { text: "Bagunça criativa", type: "C" },
      { text: "Totalmente desorganizado", type: "D" },
    ],
  },
  {
    id: 2,
