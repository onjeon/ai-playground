// Sua personalidade à Noite
// Descubra sua personalidade à noite!

export const questions = [
  {
    id: 1,
    question: "O que você faz à noite?",
    options: [
      { text: "Balada e festas", type: "A" },
      { text: "Janta e cinema", type: "B" },
      { text: "Netflix e sofá", type: "C" },
      { text: "Durmo cedo", type: "D" },
    ],
  },
  {
    id: 2,
