// Sua personalidade no Exercício
// Descubra sua personalidade no exercício!

export const questions = [
  {
    id: 1,
    question: "Como você se exercita?",
    options: [
      { text: "Academia todo dia", type: "A" },
      { text: "Esportes com amigos", type: "B" },
      { text: "Caminhada leve", type: "C" },
      { text: "Exercício? Que isso?", type: "D" },
    ],
  },
  {
    id: 2,
