// Sua personalidade de Leitura
// Descubra sua personalidade de leitura!

export const questions = [
  {
    id: 1,
    question: "Qual sua relação com leitura?",
    options: [
      { text: "Devoro livros, leio muito", type: "A" },
      { text: "Leio às vezes, quando posso", type: "B" },
      { text: "Só notícias e redes sociais", type: "C" },
      { text: "Não gosto de ler", type: "D" },
    ],
  },
  {
    id: 2,
