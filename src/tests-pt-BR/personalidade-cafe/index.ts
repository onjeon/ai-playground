// Sua personalidade do Café
// Descubra sua personalidade do café!

export const questions = [
  {
    id: 1,
    question: "Como você toma café?",
    options: [
      { text: "Várias vezes ao dia, viciado", type: "A" },
      { text: "Só de manhã para acordar", type: "B" },
      { text: "Prefiro chá ou suco", type: "C" },
      { text: "Não gosto de café", type: "D" },
    ],
  },
  {
    id: 2,
