// Sua personalidade de Série
// Descubra sua personalidade de série!

export const questions = [
  {
    id: 1,
    question: "Que tipo de série você gosta?",
    options: [
      { text: "Drama intenso e emocionante", type: "A" },
      { text: "Comédia leve e divertida", type: "B" },
      { text: "Suspense e mistério", type: "C" },
      { text: "Documentários e realidade", type: "D" },
    ],
  },
  {
    id: 2,
