// Sua personalidade com Presentes
// Descubra sua personalidade com presentes!

export const questions = [
  {
    id: 1,
    question: "Como você é com presentes?",
    options: [
      { text: "Adoro dar e receber", type: "A" },
      { text: "Prefiro dar do que receber", type: "B" },
      { text: "Prefiro receber", type: "C" },
      { text: "Não ligo muito", type: "D" },
    ],
  },
  {
    id: 2,
