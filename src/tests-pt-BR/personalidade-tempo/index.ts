// Sua personalidade com Tempo
// Descubra sua personalidade com tempo!

export const questions = [
  {
    id: 1,
    question: "Como você é com horários?",
    options: [
      { text: "Sempre pontual", type: "A" },
      { text: "Geralmente no horário", type: "B" },
      { text: "Sempre atrasado", type: "C" },
      { text: "Não ligo para horários", type: "D" },
    ],
  },
  {
    id: 2,
