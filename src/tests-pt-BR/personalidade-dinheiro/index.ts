// Sua personalidade com Dinheiro
// Descubra sua personalidade com dinheiro!

export const questions = [
  {
    id: 1,
    question: "Como você lida com dinheiro?",
    options: [
      { text: "Poupo tudo que posso", type: "A" },
      { text: "Gasto consciente", type: "B" },
      { text: "Gasto mais do que deveria", type: "C" },
      { text: "Dinheiro não é importante", type: "D" },
    ],
  },
  {
    id: 2,
