// Sua personalidade na Praia
// Descubra sua personalidade na praia!

export const questions = [
  {
    id: 1,
    question: "Como você curte a praia?",
    options: [
      { text: "Esportes e atividades na areia", type: "A" },
      { text: "Relaxando na cadeira de praia", type: "B" },
      { text: "Mergulhando e nadando", type: "C" },
      { text: "Prefiro a sombra e um livro", type: "D" },
    ],
  },
  {
    id: 2,
