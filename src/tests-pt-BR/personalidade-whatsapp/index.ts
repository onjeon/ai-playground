// Sua personalidade no WhatsApp
// Descubra sua personalidade no whatsapp!

export const questions = [
  {
    id: 1,
    question: "Como você usa o WhatsApp?",
    options: [
      { text: "Respondo na hora, sempre online", type: "A" },
      { text: "Demoro mas respondo", type: "B" },
      { text: "Só áudios, não gosto de digitar", type: "C" },
      { text: "Minimalista, só o essencial", type: "D" },
    ],
  },
  {
    id: 2,
