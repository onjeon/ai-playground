// Sua personalidade ao Acordar
// Descubra sua personalidade ao acordar!

export const questions = [
  {
    id: 1,
    question: "Como você acorda?",
    options: [
      { text: "Cedo e disposto", type: "A" },
      { text: "Preciso de vários alarmes", type: "B" },
      { text: "Devagar, demoro para funcionar", type: "C" },
      { text: "Só acordo tarde", type: "D" },
    ],
  },
  {
    id: 2,
