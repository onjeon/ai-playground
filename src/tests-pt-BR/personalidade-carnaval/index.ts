// Sua personalidade no Carnaval
// Descubra sua personalidade no carnaval!
...
export const questions = [
  {
    ...
    options: [
      { text: "Na avenida, sambando muito!", type: "A" },
      { text: "Em bloco de rua com amigos", type: "B" },
      { text: "Em casa assistindo na TV", type: "C" },
      { text: "Viajo para fugir da folia", type: "D" },
    ],
  },
  {
    id: 2,
