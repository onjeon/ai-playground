// Sua personalidade na Arte
// Descubra sua personalidade na arte!

export const questions = [
  {
    id: 1,
    question: "Qual sua relação com arte?",
    options: [
      { text: "Artista de coração", type: "A" },
      { text: "Aprecio como espectador", type: "B" },
      { text: "Não entendo muito", type: "C" },
