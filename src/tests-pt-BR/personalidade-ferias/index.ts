// Sua personalidade nas Férias
// Descubra sua personalidade nas férias!

export const questions = [
  {
    id: 1,
    question: "Como você curte férias?",
    options: [
      { text: "Viagem internacional", type: "A" },
      { text: "Praia no Brasil", type: "B" },
      { text: "Ficar em casa", type: "C" },
      { text: "Trabalhar menos intenso", type: "D" },
    ],
  },
  {
    id: 2,
