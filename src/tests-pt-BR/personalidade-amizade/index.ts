// Sua personalidade na Amizade
// Descubra sua personalidade na amizade!

export const questions = [
  {
    id: 1,
    question: "Como você é como amigo?",
    options: [
      { text: "Presente e leal sempre", type: "A" },
      { text: "Poucos mas bons amigos", type: "B" },
      { text: "Social mas superficial", type: "C" },
      { text: "Prefiro ficar sozinho", type: "D" },
    ],
  },
  {
    id: 2,
