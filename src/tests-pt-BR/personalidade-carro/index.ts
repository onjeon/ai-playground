// Sua personalidade no Carro
// Descubra sua personalidade no carro!
...
export const questions = [
  {
    ...
    options: [
      { text: "Rápido e ousado", type: "A" },
      { text: "Calmo e defensivo", type: "B" },
      { text: "Só quando necessário", type: "C" },
      { text: "Prefiro ser passageiro", type: "D" },
    ],
  },
  {
    id: 2,
