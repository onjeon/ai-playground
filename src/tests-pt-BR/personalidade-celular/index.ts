// Sua personalidade no Celular
// Descubra sua personalidade no celular!

export const questions = [
  {
    id: 1,
    question: "Como você usa o celular?",
    options: [
      { text: "Viciado, não largo nunca", type: "A" },
      { text: "Uso moderado", type: "B" },
      { text: "Só para ligações e mensagens", type: "C" },
      { text: "Queria viver sem celular", type: "D" },
    ],
  },
  {
    id: 2,
