// Sua personalidade com Saúde
// Descubra sua personalidade com saúde!

export const questions = [
  {
    id: 1,
    question: "Como você cuida da saúde?",
    options: [
      { text: "Muito saudável, me cuido", type: "A" },
      { text: "Tento me cuidar", type: "B" },
      { text: "Poderia ser melhor", type: "C" },
      { text: "Não me preocupo muito", type: "D" },
    ],
  },
  {
    id: 2,
