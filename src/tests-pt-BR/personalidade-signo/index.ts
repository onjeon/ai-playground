// Qual é a sua personalidade do signo?
// Descubra qual é a sua personalidade do signo?!

export const questions = [
  {
    id: 1,
    question: "Qual é o seu signo do zodíaco?",
    options: [
      { text: "Áries - fogo e paixão", type: "A" },
      { text: "Touro - terra e estabilidade", type: "B" },
      { text: "Gêmeos - ar e comunicação", type: "C" },
      { text: "Peixes - água e intuição", type: "D" },
    ],
  },
  {
    id: 2,
