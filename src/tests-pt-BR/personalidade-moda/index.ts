// Sua personalidade na Moda
// Descubra sua personalidade na moda!

export const questions = [
  {
    id: 1,
    question: "Qual sua relação com moda?",
    options: [
      { text: "Fashionista, amo tendências", type: "A" },
      { text: "Me visto bem mas simples", type: "B" },
      { text: "Conforto acima de tudo", type: "C" },
      { text: "Não ligo para roupa", type: "D" },
    ],
  },
  {
    id: 2,
