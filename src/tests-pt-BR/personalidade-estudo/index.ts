// Sua personalidade no Estudo
// Descubra sua personalidade no estudo!

export const questions = [
  {
    id: 1,
    question: "Como você estuda?",
    options: [
      { text: "Focado e disciplinado", type: "A" },
      { text: "Em grupo, colaborativo", type: "B" },
      { text: "Só na pressão", type: "C" },
      { text: "Não gosto de estudar", type: "D" },
    ],
  },
  {
    id: 2,
