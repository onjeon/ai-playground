// Sua personalidade em Viagem
// Descubra sua personalidade em viagem!

export const questions = [
  {
    id: 1,
    question: "Como você viaja?",
    options: [
      { text: "Mochileiro aventureiro", type: "A" },
      { text: "Roteiro planejado", type: "B" },
      { text: "Resort all-inclusive", type: "C" },
      { text: "Prefiro ficar em casa", type: "D" },
    ],
  },
  {
    id: 2,
