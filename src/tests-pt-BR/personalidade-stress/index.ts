// Sua personalidade sob Stress
// Descubra sua personalidade sob stress!

export const questions = [
  {
    id: 1,
    question: "Como você reage ao stress?",
    options: [
      { text: "Enfrento e resolvo", type: "A" },
      { text: "Fico ansioso mas lido", type: "B" },
      { text: "Me isolo para processar", type: "C" },
      { text: "Explodo ou choro", type: "D" },
    ],
  },
  {
    id: 2,
