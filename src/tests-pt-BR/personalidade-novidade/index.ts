// Sua personalidade com Novidades
// Descubra sua personalidade com novidades!
...
export const questions = [
  {
    ...
    options: [
      { text: "Adoro novidades!", type: "A" },
      { text: "Aceito se fizer sentido", type: "B" },
      { text: "Prefiro o familiar", type: "C" },
      { text: "Odeio mudanças", type: "D" },
    ],
  },
  {
    id: 2,
