// Sua personalidade com Risco
// Descubra sua personalidade com risco!
...
export const questions = [
  {
    ...
    options: [
      { text: "Adoro adrenalina", type: "A" },
      { text: "Riscos calculados", type: "B" },
      { text: "Prefiro segurança", type: "C" },
      { text: "Evito qualquer risco", type: "D" },
    ],
  },
  {
    id: 2,
