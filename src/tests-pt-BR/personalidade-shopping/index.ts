// Sua personalidade no Shopping
// Descubra sua personalidade no shopping!

export const questions = [
  {
    id: 1,
    question: "Como você é no shopping?",
    options: [
      { text: "Compro tudo que vejo", type: "A" },
      { text: "Só o que preciso", type: "B" },
      { text: "Vitrine apenas, não compro", type: "C" },
      { text: "Evito shopping", type: "D" },
    ],
  },
  {
    id: 2,
