// Sua personalidade no Feriado
// Descubra sua personalidade no feriado!

export const questions = [
  {
    id: 1,
    question: "O que você faz no feriado?",
    options: [
      { text: "Viajo sempre que posso", type: "A" },
      { text: "Fico em casa descansando", type: "B" },
      { text: "Aproveito para resolver coisas", type: "C" },
      { text: "Saio com amigos e família", type: "D" },
    ],
  },
  {
    id: 2,
