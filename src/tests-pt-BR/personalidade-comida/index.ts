// Sua personalidade na Comida
// Descubra sua personalidade na comida!

export const questions = [
  {
    id: 1,
    question: "Qual sua relação com comida?",
    options: [
      { text: "Gourmet, amo experimentar", type: "A" },
      { text: "Tradicional, arroz e feijão", type: "B" },
      { text: "Como qualquer coisa", type: "C" },
      { text: "Sou muito exigente", type: "D" },
    ],
  },
  {
    id: 2,
