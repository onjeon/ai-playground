// Seu Fim de Semana Ideal
// Descubra seu fim de semana ideal!

export const questions = [
  {
    id: 1,
    question: "O que você faz no fim de semana?",
    options: [
      { text: "Sair e curtir", type: "A" },
      { text: "Família e amigos", type: "B" },
      { text: "Descansar em casa", type: "C" },
      { text: "Resolver pendências", type: "D" },
    ],
  },
  {
    id: 2,
