// Sua personalidade no Conflito
// Descubra sua personalidade no conflito!
...
export const questions = [
  {
    ...
    options: [
      { text: "Enfrento diretamente", type: "A" },
      { text: "Busco acordo", type: "B" },
      { text: "Evito confronto", type: "C" },
      { text: "Deixo o tempo resolver", type: "D" },
    ],
  },
  {
    id: 2,
