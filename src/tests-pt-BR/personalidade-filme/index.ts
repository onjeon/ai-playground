// Sua personalidade de Filme
// Descubra sua personalidade de filme!

export const questions = [
  {
    id: 1,
    question: "Que filmes você prefere?",
    options: [
      { text: "Ação e aventura", type: "A" },
      { text: "Romance e drama", type: "B" },
      { text: "Comédia e diversão", type: "C" },
      { text: "Terror e suspense", type: "D" },
    ],
  },
  {
    id: 2,
