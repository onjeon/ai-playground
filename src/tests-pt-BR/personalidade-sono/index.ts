// Sua personalidade do Sono
// Descubra sua personalidade do sono!
...
export const questions = [
  {
    ...
    options: [
      { text: "Durmo bem, acordo disposto", type: "A" },
      { text: "Insônia às vezes", type: "B" },
      { text: "Durmo demais", type: "C" },
      { text: "Sono irregular", type: "D" },
    ],
  },
  {
    id: 2,
