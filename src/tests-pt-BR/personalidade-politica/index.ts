...
// Descubra sua personalidade política!

export const questions = [
  {
    id: 1,
    question: "Qual sua relação com política?",
    options: [
      { text: "Muito engajado", type: "A" },
      { text: "Acompanho mas não milito", type: "B" },
      { text: "Só nas eleições", type: "C" },
