// Sua personalidade no Churrasco
// Descubra sua personalidade no churrasco!

export const questions = [
  {
    id: 1,
    question: "Qual é o seu papel no churrasco?",
    options: [
      { text: "Sou o churrasqueiro oficial", type: "A" },
      { text: "Cuido das bebidas e música", type: "B" },
      { text: "Só como e converso", type: "C" },
      { text: "Ajudo a organizar tudo", type: "D" },
    ],
  },
  {
    id: 2,
