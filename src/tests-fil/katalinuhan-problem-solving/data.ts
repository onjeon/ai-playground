// Katalinuhan sa Problem Solving
// Gaano ka sa problem solving?

export const questions = [
  {
    id: 1,
    question: "Gaano ka sa problem solving?",
    options: [
