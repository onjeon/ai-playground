// Personalidad sa Netflix
// Paano ka manonood ng Netflix?

export const questions = [
  {
    id: 1,
    question: "Paano ka manonood ng Netflix?",
    options: [
