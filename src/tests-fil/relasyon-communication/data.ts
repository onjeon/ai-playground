// Paraan ng Komunikasyon sa Partner
// Paano ka nag-communicate?

export const questions = [
  {
    id: 1,
    question: "Paano ka nag-communicate?",
    options: [
