// Paraan ng Deadline Handling
// Paano mo hinahandle ang deadlines?

export const questions = [
  {
    id: 1,
    question: "Paano mo hinahandle ang deadlines?",
    options: [
