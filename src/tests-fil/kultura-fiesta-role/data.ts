// Kultura sa Fiesta Role
// Ano ang role mo sa fiesta?

export const questions = [
  {
    id: 1,
    question: "Ano ang role mo sa fiesta?",
    options: [
