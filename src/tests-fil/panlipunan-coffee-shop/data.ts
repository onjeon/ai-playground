// Panlipunan sa Coffee Shop
// Paano ka sa coffee shop?

export const questions = [
  {
    id: 1,
    question: "Paano ka sa coffee shop?",
    options: [
