...
// Paano mo pinakikita ang pagmamahal?

export const questions = [
  {
    id: 1,
    question: "Paano mo pinakikita ang pagmamahal?",
    options: [
      { text: "Oo, palagi!", type: "A" },
      { text: "Minsan lang", type: "B" },
      { text: "Bihira", type: "C" },
      { text: "Hindi talaga", type: "D" },
    ],
  },
  {
    id: 2,
...
export const results = {
  A: {
    type: "A",
    title: "Ano ang Love Language Mo Type A",
    emoji: "🔥",
    description: "Ikaw ay matapang, decisive, at action-oriented! Natural leader ka at hindi ka takot kumilos.",
    traits: ["Matapang", "Leader", "Decisive", "Action-oriented"],
    strengths: ["Natural leadership", "Quick decision maker", "Gets things done"],
    weaknesses: ["Minsan too aggressive", "Baka ma-overwhelm ang iba"],
    tips: ["Balance action with reflection", "Listen to others more"],
  },
  B: {
    type: "B",
    title: "Ano ang Love Language Mo Type B",
    emoji: "⚖️",
    description: "Ikaw ay organized, thoughtful, at balanced! Maayos ang approach mo sa buhay.",
    traits: ["Organized", "Thoughtful", "Balanced", "Strategic"],
    strengths: ["Excellent planner", "Reliable and consistent", "Good at analysis"],
    weaknesses: ["Minsan overthinking", "Too cautious"],
    tips: ["Trust your instincts more", "Take calculated risks"],
  },
  C: {
    type: "C",
    title: "Ano ang Love Language Mo Type C",
    emoji: "😌",
    description: "Ikaw ay chill, peaceful, at content! Priority mo ang happiness at peace of mind.",
    traits: ["Chill", "Peaceful", "Content", "Easy-going"],
    strengths: ["Stress-free mindset", "Appreciates simple joys", "Emotionally balanced"],
    weaknesses: ["Minsan walang ambition", "Too passive"],
    tips: ["Set some goals", "Push yourself minsan"],
  },
  D: {
    type: "D",
    title: "Ano ang Love Language Mo Type D",
    emoji: "🌊",
    description: "Ikaw ay flexible, adaptable, at spontaneous! Go with the flow ka.",
    traits: ["Flexible", "Adaptable", "Spontaneous", "Independent"],
    strengths: ["Highly adaptable", "Low stress levels", "Open to possibilities"],
    weaknesses: ["Walang direction minsan", "Inconsistent"],
