// Makabago sa Real Estate
// Paano ka sa real estate?

export const questions = [
  {
    id: 1,
    question: "Paano ka sa real estate?",
    options: [
