// Kultura sa Utang na Loob
// Paano ka sa utang na loob?

export const questions = [
  {
    id: 1,
    question: "Paano ka sa utang na loob?",
    options: [
