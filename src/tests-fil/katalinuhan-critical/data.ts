// Katalinuhan sa Critical Thinking
// Gaano ka critical thinker?

export const questions = [
  {
    id: 1,
    question: "Gaano ka critical thinker?",
    options: [
