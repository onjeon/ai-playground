// Makabago sa Online Banking
// Paano ka sa online banking?

export const questions = [
  {
    id: 1,
    question: "Paano ka sa online banking?",
    options: [
