// Lebel ng Pagiging Decisive
// Gaano ka kabilis mag-decide?

export const questions = [
  {
    id: 1,
    question: "Gaano ka kabilis mag-decide?",
    options: [
