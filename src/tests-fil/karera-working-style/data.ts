// Estilo ng Pagtrabaho
// Paano ka nagtratrabaho?

export const questions = [
  {
    id: 1,
    question: "Paano ka nagtratrabaho?",
    options: [
