// Personalidad sa Spotify
// Anong music listener ka?

export const questions = [
  {
    id: 1,
    question: "Anong music listener ka?",
    options: [
