// Makabago sa Freelancing
// Paano ka sa freelancing?

export const questions = [
  {
    id: 1,
    question: "Paano ka sa freelancing?",
    options: [
