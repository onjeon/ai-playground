// Estilo sa Carinderia
// Paano ka sa carinderia?

export const questions = [
  {
    id: 1,
    question: "Paano ka sa carinderia?",
    options: [
