// Personalidad sa Messenger
// Paano ka sa Messenger?

export const questions = [
  {
    id: 1,
    question: "Paano ka sa Messenger?",
    options: [
