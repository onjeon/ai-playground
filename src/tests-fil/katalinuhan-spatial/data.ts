// Katalinuhan sa Spatial
// Gaano ka sa spatial reasoning?

export const questions = [
  {
    id: 1,
    question: "Gaano ka sa spatial reasoning?",
    options: [
