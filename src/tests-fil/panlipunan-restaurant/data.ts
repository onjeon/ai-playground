// Panlipunan sa Restaurant
// Paano ka sa restaurant?

export const questions = [
  {
    id: 1,
    question: "Paano ka sa restaurant?",
    options: [
