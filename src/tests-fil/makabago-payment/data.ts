// Makabago sa Digital Payment
// Paano ka sa digital payment?

export const questions = [
  {
    id: 1,
    question: "Paano ka sa digital payment?",
    options: [
