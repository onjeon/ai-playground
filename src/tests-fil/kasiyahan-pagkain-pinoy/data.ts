// Pagkaing Pinoy na Swak sa Iyo
// Anong ulam ang paborito mo?

export const questions = [
  {
    id: 1,
    question: "Anong ulam ang paborito mo?",
    options: [
