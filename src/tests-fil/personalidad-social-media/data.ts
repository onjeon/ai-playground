// Personalidad sa Social Media
// Anong social media user ka?

export const questions = [
  {
    id: 1,
    question: "Anong social media user ka?",
    options: [
