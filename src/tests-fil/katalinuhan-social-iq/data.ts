// Katalinuhan sa Social IQ
// Gaano ka sa social intelligence?

export const questions = [
  {
    id: 1,
    question: "Gaano ka sa social intelligence?",
    options: [
