// Katalinuhan sa Financial
// Gaano ka financially literate?

export const questions = [
  {
    id: 1,
    question: "Gaano ka financially literate?",
    options: [
