// Kultura sa Pakikisama
// Gaano ka sa pakikisama?

export const questions = [
  {
    id: 1,
    question: "Gaano ka sa pakikisama?",
    options: [
