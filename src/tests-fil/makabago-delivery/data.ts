// Makabago sa Delivery
// Paano ka sa delivery apps?

export const questions = [
  {
    id: 1,
    question: "Paano ka sa delivery apps?",
    options: [
