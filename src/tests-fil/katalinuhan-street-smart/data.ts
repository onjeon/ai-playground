// Katalinuhan sa Street Smart
// Gaano ka street smart?

export const questions = [
  {
    id: 1,
    question: "Gaano ka street smart?",
    options: [
