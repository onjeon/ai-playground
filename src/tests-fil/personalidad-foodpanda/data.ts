// Personalidad sa Foodpanda
// Paano ka mag-order ng food?

export const questions = [
  {
    id: 1,
    question: "Paano ka mag-order ng food?",
    options: [
