  ...
  return (
    <div className="space-y-6">
      ...
      <div className="text-center">
        ...
        <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">팀 나누기</h2>
      ...
      {teams.length === 0 ? (
        <>
          ...
          <div className="bg-gray-50 dark:bg-gray-800 rounded-2xl p-4">
            <div className="grid grid-cols-2 gap-2">
              <button
                ...
                className={`py-3 rounded-xl font-bold transition-all ${mode === 'name' ? 'bg-indigo-500 text-white' : 'bg-white dark:bg-gray-700 text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-600'}`}
              >
                📝 이름 입력
              </button>
              <button
                onClick={() => setMode('number')}
                className={`py-3 rounded-xl font-bold transition-all ${mode === 'number' ? 'bg-indigo-500 text-white' : 'bg-white dark:bg-gray-700 text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-600'}`}
              >
                🔢 번호로
              </button>
            </div>
          ...
          <div className="bg-gray-50 dark:bg-gray-800 rounded-2xl p-6">
            {mode === 'name' ? (
              <div>
                <label className="text-gray-500 dark:text-gray-400 text-sm block mb-2">
                ...
                <textarea
                  ...
                  className="w-full bg-white dark:bg-gray-700 text-gray-900 dark:text-white px-4 py-3 rounded-xl resize-none h-32 border border-gray-200 dark:border-gray-600"
                />
              ...
              <div>
                <label className="text-gray-500 dark:text-gray-400 text-sm block mb-4 text-center">인원수</label>
                <div className="flex items-center justify-center gap-4">
                  <button
                    onClick={() => setNumberCount(prev => Math.max(2, prev - 1))}
                    className="w-12 h-12 bg-white dark:bg-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 rounded-xl text-gray-900 dark:text-white text-2xl font-bold border border-gray-200 dark:border-gray-600"
                  >
                    -
                  </button>
                  <span className="text-4xl font-bold text-gray-900 dark:text-white w-16 text-center">{numberCount}</span>
                  <button
                ...
                <p className="text-gray-400 dark:text-gray-500 text-sm text-center mt-2">1번 ~ {numberCount}번</p>
              </div>
            )}
          </div>
          ...
          {/* Team Count */}
          <div className="bg-gray-50 dark:bg-gray-800 rounded-2xl p-6">
            <label className="text-gray-500 dark:text-gray-400 text-sm block mb-4 text-center">팀 수</label>
            <div className="flex items-center justify-center gap-4">
              <button
              ...
              <span className="text-4xl font-bold text-gray-900 dark:text-white w-16 text-center">{teamCount}</span>
              <button
            ...
            <p className="text-gray-400 dark:text-gray-500 text-sm text-center mt-2">최소 2팀 ~ 최대 8팀</p>
          ...
          <button
            ...
            className="w-full py-4 bg-gradient-to-r from-blue-500 to-indigo-500 hover:from-blue-400 hover:to-indigo-400 disabled:from-gray-300 disabled:to-gray-300 dark:disabled:from-gray-600 dark:disabled:to-gray-600 text-white font-bold rounded-xl transition-all active:scale-[0.98] text-xl"
          >
