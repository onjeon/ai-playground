      ...
      <div className="flex gap-2 justify-center">
        <div className="flex-1 max-w-[90px]">
          <input
            ...
            className="w-full px-2 py-3 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl text-gray-900 dark:text-white text-center text-sm focus:outline-none focus:border-indigo-500 transition-colors"
            maxLength={4}
          />
    ...
    <div className="space-y-6">
      ...
      <div className="text-center">
        <div className="inline-flex items-center gap-2 px-4 py-2 bg-indigo-50 dark:bg-indigo-900/30 rounded-full mb-4">
          ...
          <span className="text-indigo-600 dark:text-indigo-300 text-sm font-medium">2025 궁합 운세</span>
        </div>
      ...
      <div className="bg-gray-50 dark:bg-gray-800 rounded-2xl p-5 border border-gray-100 dark:border-gray-700">
        ...
        <div className="space-y-3 text-sm">
          <div className="flex gap-3">
            ...
            <div>
              <div className="text-gray-900 dark:text-white font-medium">띠 궁합 (60%)</div>
              <div className="text-gray-400 dark:text-gray-500 text-xs">삼합(三合), 육합(六合), 상충(相沖) 등 전통 사주학 기반</div>
            </div>
          </div>
          <div className="flex gap-3">
            <span className="text-xl">⭐</span>
            <div>
              <div className="text-gray-900 dark:text-white font-medium">별자리 궁합 (40%)</div>
              <div className="text-gray-400 dark:text-gray-500 text-xs">불/흙/공기/물 4원소의 조화와 상생 관계 분석</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-gray-50 dark:bg-gray-800 rounded-2xl p-5 border border-gray-100 dark:border-gray-700">
        <div className="flex items-center justify-center gap-1 mb-3">
          ...
          <span className="text-gray-900 dark:text-white font-bold ml-2">4.9</span>
        </div>
