...
import { Search, ArrowLeft, Grid3X3, Flame, Clock, Sparkles, Tag, X, ChevronDown, ChevronUp } from 'lucide-react';
    ...
    <div className="space-y-4">
      ...
      <section className="bg-white dark:bg-gray-800 rounded-xl p-4 border border-gray-100 dark:border-gray-700">
        ...
        <div className="sm:hidden space-y-2">
          ...
          {/* 2행: 전체/무료/프리미엄 + 태그 (풀너비) */}
          <div className="grid grid-cols-4 gap-1.5">
            {(['all', 'free', 'premium'] as FilterType[]).map((filter) => (
              <button
                key={filter}
            ...
            <button
              ...
              className={`py-2 rounded-lg text-xs font-medium transition-colors flex items-center justify-center gap-1 ${
