...
import { getZodiacFortune } from '@/data/premium/zodiac-fortune';
...
function ZodiacFortuneResult() {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-b from-indigo-950 to-slate-950 flex items-center justify-center">
        <div className="text-center text-white">
          ...
          <Link href="/premium/zodiac-fortune" className="text-blue-400 underline">
            다시 시작하기
          </Link>
        </div>
      </div>
  ...
  const handleShare = async () => {
    ...
    if (navigator.share) {
      ...
      await navigator.clipboard.writeText(shareText + '\n' + window.location.origin + '/premium/zodiac-fortune');
      alert('클립보드에 복사되었습니다!');
    }
  };
